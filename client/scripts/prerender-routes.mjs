...
const methodologyTemplatePath = path.resolve(
  process.cwd(),
  'scripts',
  'templates',
  'methodology-static.html'
);
const pricingTemplatePath = path.resolve(
  process.cwd(),
  'scripts',
  'templates',
  'pricing-static.html'
  ...
  for (const { file, routeCluster } of clusterFiles) {
    ...
    try {
      ...
      for (let i = 0; i < slugPositions.length; i++) {
        ...
        const routePath =
          routeCluster === 'compare' ? `/compare/${slug}` : `/${routeCluster}/${slug}`;
...
const routes = [
  {
    path: '/',
    title: 'AiVIS.biz | AI Visibility Audit — Evidence-Linked Scores',
    description:
      'AiVIS.biz analyzes whether AI systems like ChatGPT, Perplexity AI, Google AI Overviews, and Claude can correctly read, interpret, and cite your website. Every result is tied to real on-page evidence, not assumptions.',
    ogTitle: 'AiVIS — AI Visibility Audit | Evidence-Backed by CITE LEDGER',
    ogDescription:
      'AiVIS.biz analyzes whether AI systems like ChatGPT, Perplexity AI, Google AI Overviews, and Claude can correctly read, interpret, and cite your website. Evidence-backed findings and prioritized fixes.',
  ...
  },
  {
    ...
    description:
      'Measure whether AI can read, trust and cite your site with a live evidence-backed AiVIS.biz audit.',
  },
  {
    path: '/pricing',
    title: 'AiVIS.biz Pricing | AI Visibility Audit Plans',
    description:
      'AiVIS.biz plans: Observer free tier plus Alignment, Signal, and legacy Score Fix options with multi-model validation and team reporting webhooks: Notion, Slack, Google Sheets, Zapier and more.',
  },
  {
    path: '/analyze',
    title: 'Run AI Visibility Audit | AiVIS.biz',
    description:
      'Run a live AI visibility audit to measure parseability, trust and citation readiness with evidence-backed scoring.',
  },
  {
    path: '/faq',
    title: 'AiVIS.biz FAQ | AI Visibility Audit Questions',
    description:
      'Answers about AI visibility scoring, structured findings, answer engine readiness and how AiVIS.biz audits websites.',
  },
  {
    path: '/guide',
    title: 'AiVIS.biz Guide | AI Visibility Workflow',
    description:
      'Learn how to run audits, read evidence-backed findings and ship fixes that improve AI visibility.',
  },
  {
    path: '/workflow',
    title: 'AiVIS.biz Workflow | End-to-End Visibility Operations',
    description:
      'Turn AiVIS.biz from a one-off audit into a repeatable AI visibility workflow with baseline, fixes and re-audit loops.',
  },
  {
    path: '/methodology',
    title: 'AiVIS.biz Methodology | CITE LEDGER & BRAG Evidence Protocol',
    description:
      'How AiVIS.biz audits AI answer readiness: six weighted dimensions, the CITE LEDGER evidence pipeline, and the BRAG Trail protocol that ground every finding in crawl-observable data.',
    ogTitle: 'AiVIS.biz Methodology — CITE LEDGER & BRAG Evidence Protocol',
    ogDescription:
      'CITE LEDGER evidence pipeline, BRAG protocol, six dimension weights, triple-check consensus, score bands, and methodology FAQ.',
    ogType: 'article',
  },
  {
    path: '/insights',
  ...
  },
  {
    ...
    description:
      'Canonical AiVIS.biz blog posts sourced from Intruvurt.medium.com writing, hosted on aivis.biz/blogs for clean ownership and schema consistency.',
  },
  {
    path: '/blogs/why-i-built-aivis-when-i-realized-most-websites-are-invisible-to-ai',
    title:
      'Why I Built AiVIS.biz When I Realized Most Websites Are Invisible To AI | AiVIS.biz Blogs',
    description:
      'The origin story behind AiVIS.biz and why evidence-backed AI visibility auditing matters for modern answer-engine discovery.',
    ogType: 'article',
  },
  {
    ...
    description:
      'A practical founder filter for distribution risk and discoverability before committing to another product build cycle.',
    ogType: 'article',
  },
  {
    path: '/blogs/answer-engine-optimization-2026-why-citation-readiness-matters',
    title:
      'Answer Engine Optimization in 2026 - Why Citation Readiness Matters More Than Ranking | AiVIS.biz Blogs',
    description:
  ...
  },
  {
    ...
    title:
      'Building Author Authority for Citation Workflows - E-E-A-T in the AI Era | AiVIS.biz Blogs',
    description:
  ...
  },
  {
    ...
    title:
      'How LLMs Parse Your Content - Technical Breakdown of ChatGPT, Claude, and Perplexity Extraction | AiVIS.biz Blogs',
    description:
  ...
  },
  {
    ...
    title:
      'Geo-Adaptive AI Ranking - How Location Intelligence Shapes AI Answer Quality | AiVIS.biz Blogs',
    description:
      'Answer engines now factor regional availability, jurisdiction, and localized entity resolution into citation eligibility.',
    ogType: 'article',
  },
  {
    path: '/blogs/from-invisible-to-cited-case-study-brand-citation-growth',
    title:
      'From Invisible to Cited - Real Case Study: How Brands Move from 0 to 87% Citation Rate | AiVIS.biz Blogs',
    description:
  ...
  },
  {
    ...
    title:
      'The 7-Step Implementation Roadmap: From Audit to Live Citations in 30 Days | AiVIS.biz Blogs',
    description:
  ...
  },
  {
    ...
    description:
      'Full breakdown of AiVIS.biz API and WebMCP access: how to generate keys, authenticate requests, pull audit data, trigger scans, and integrate visibility intelligence into your own stack.',
    ogType: 'article',
  },
  {
  ...
  },
  {
    ...
    title:
      'AI Visibility Tools in 2026: What Semrush, Ahrefs, and Moz Cannot Measure | AiVIS.biz Blogs',
    description:
  ...
  },
  {
    ...
    title:
      'How to Get Cited by ChatGPT, Perplexity, and Gemini: The Structural Blueprint for AI Citations | AiVIS.biz Blogs',
    description:
  ...
  },
  {
    ...
    description:
      'The gap between traditional SEO tools and what AI answer engines actually need is costing businesses citations every day. AiVIS.biz closes that gap for agencies managing multiple clients and SMBs competing against bigger brands.',
    ogType: 'article',
  },
  {
    path: '/blogs/team-workspaces-how-aivis-handles-multi-client-agency-operations',
    title:
      'Team Workspaces: How AiVIS.biz Handles Multi-Client Agency Operations | AiVIS.biz Blogs',
    description:
  ...
  },
  {
    ...
    title:
      'Citation Testing Explained: How to Verify AI Models Can Actually Find You | AiVIS.biz Blogs',
    description:
  ...
  },
  {
    ...
    description:
      'AI models learn about new brands from community platforms. AiVIS.biz scans nine free sources to show you where your brand signal lives and where it is missing.',
    ogType: 'article',
  },
  {
  ...
  },
  {
    ...
    title:
      'The SSFR Evidence Framework: The Scoring Engine Behind Every AiVIS.biz Audit | AiVIS.biz Blogs',
    description:
  ...
  },
  {
    ...
    title:
      'Score Fix AutoFix PR: How AI Opens Pull Requests to Fix Your Visibility | AiVIS.biz Blogs',
    description:
  ...
  },
  {
    ...
    title:
      'Reverse Engineering Competitors: Decompile, Ghost Audit, and Simulate | AiVIS.biz Blogs',
    description:
      'Take apart any competitor page structure. Run a ghost audit without them knowing. Simulate how AI models evaluate their content versus yours.',
    ogType: 'article',
  },
  {
    path: '/blogs/free-tools-schema-validator-robots-checker-content-extractability',
    title:
      'Three Free Tools: Schema Validator, Robots Checker, and Content Extractability | AiVIS.biz Blogs',
    description:
  ...
  },
  {
    ...
    title:
      'BIX: Boundaries in Excess - How GuideBot Redefines AI Platform Assistants | AiVIS.biz Blogs',
    description:
      'GuideBot is not a chatbot. It is a bounded intelligence system built around page-aware context, tier-gated recommendations, and a closed knowledge graph. Here is why that matters.',
    ogType: 'article',
  },
  {
    path: '/blogs/your-website-is-not-competing-for-clicks-anymore',
    title:
      'Your Website Is Not Competing for Clicks Anymore. It Is Competing to Be Included. | AiVIS.biz Blogs',
    description:
  ...
  },
  {
    ...
    description:
      'Understand why AI answer engines are replacing traditional search and why citation readiness now drives visibility.',
  },
  {
    path: '/ai-search-visibility-2026',
    title: 'AI Search Visibility in 2026 | AiVIS.biz',
    description:
      'A strategic breakdown of how AI search visibility is changing in 2026 and what teams must fix now.',
  },
  {
    path: '/aeo-playbook-2026',
    title: 'AEO Playbook 2026 | AiVIS.biz',
    description:
      'A practical AEO playbook for building answer-engine-ready pages that AI systems can interpret and cite.',
  },
  {
    path: '/geo-ai-ranking-2026',
    title: 'Geo AI Ranking 2026 | AiVIS.biz',
    description:
      'Learn how geography-aware answer engines interpret location relevance, trust, and structured local content.',
  },
  {
    path: '/compare',
    title: 'AiVIS.biz Compare | Alternative Benchmarking',
    description:
      'Compare AiVIS.biz against other AI visibility and answer-engine optimization platforms across evidence, scoring, and workflow depth.',
  },
  {
    path: '/compare/aivis-vs-otterly',
    title: 'AiVIS.biz vs Otterly | AI Visibility Comparison',
    description:
      'Detailed comparison of AiVIS.biz vs Otterly for actionable AI visibility scoring, evidence trails, and implementation-ready fixes.',
  },
  {
    path: '/compare/aivis-vs-reaudit',
    title: 'AiVIS.biz vs Reaudit | AI Visibility Comparison',
    description:
      'See how AiVIS.biz compares to Reaudit for AEO-era auditing, machine readability analysis, and structured recommendation depth.',
  },
  {
    path: '/compare/aivis-vs-profound',
    title: 'AiVIS.biz vs Profound | AI Visibility Comparison',
    description:
      'See why AiVIS.biz focuses on evidence-backed site fixes, not just monitoring mentions across AI answer surfaces.',
  },
  {
  ...
  },
  {
    ...
    description:
      '60+ in-depth definitions for AI visibility, answer engine optimization, distortion mapping, evidence-backed scoring, BRAG evidence trails, SSFR analysis, triple-check orchestration, and citation readiness.',
  },
  {
    path: '/benchmarks',
    title: 'AI Search Visibility Benchmarks 2026 | AiVIS.biz',
    description:
      'Benchmark data on extractability, content structure, and AI visibility performance across real websites.',
  },
  {
    path: '/about',
    title: 'About AiVIS.biz | Intruvurt Labs',
    description:
      'About AiVIS.biz and Intruvurt Labs: the AiVIS.biz | CITE LEDGER  focused on answer-engine readiness and evidence-backed fixes.',
  },
  {
    path: '/press',
    title: 'Press & Media | AiVIS.biz',
    description:
      'Press resources, media coverage, and public milestones for AiVIS.biz by Intruvurt Labs. TechCrunch Startup Battlefield Top 200 nominee.',
  },
  {
    path: '/compliance',
  ...
  },
  {
    ...
    description:
      'AI Visibility terms of service governing use of the AI visibility auditing platform, including acceptable use, billing, IP rights, and disclaimers.',
  },
  {
    path: '/privacy',
    title: 'Privacy Policy | AI Visibility Platform',
    description:
      'How AI Visibility and Intruvurt Labs collect, use, and protect your data across AI analysis, competitor tracking, citation testing, and brand mention scanning.',
  },
  {
    path: '/disclosures',
    title: 'Consumer Disclosures | AI Visibility Platform',
    description:
      'AI Visibility consumer disclosures covering AI accuracy limitations, competitive intelligence boundaries, threat detection scope, third-party dependencies, and platform disclaimers.',
  },
  {
    path: '/integrations',
    title: 'Integrations Hub | AI Visibility Platform',
    description:
      'Explore AI Visibility integrations, automation endpoints, and connected workflows for analytics and operations.',
  },
  {
    path: '/competitive-landscape',
    title: 'Competitive Landscape | AI Visibility Platform',
    description:
      'Compare your AI visibility performance against competitors using evidence-backed benchmarking and insights.',
  },
  {
    path: '/score-fix',
    title: 'Score Fix | AI Visibility Platform',
    description:
      'Score Fix workflows for evidence-linked remediation, implementation guidance, and audit-driven improvement loops.',
  },
  {
    path: '/api-docs',
    title: 'AI Visibility API Documentation',
    description:
      'Documentation for AI Visibility APIs covering audits, analytics, evidence, and visibility workflows.',
  },
  {
    path: '/help',
  ...
  },
  {
    ...
    description:
      'Customer support and help resources for AI Visibility platform usage, billing, and troubleshooting.',
  },
  {
    path: '/server-headers',
  ...
  },
  {
    ...
    description:
      'Public license verification page for validating AI Visibility license keys and status.',
  },
  ...
  },
  {
    ...
    description:
      'Free tool to validate structured data (JSON-LD, OpenGraph, Twitter Cards) for AI citation readiness. See what AI models can extract from your page.',
  },
  {
    path: '/tools/robots-checker',
    title: 'AI Crawler Access Checker - Robots.txt Audit for AI Bots | AI Visibility Platform',
    description:
      'Free tool to check if GPTBot, ClaudeBot, Googlebot, and 12 other AI crawlers can access your site. Audit robots.txt, meta robots, and X-Robots-Tag.',
  },
  {
    path: '/tools/content-extractability',
    title: 'Content Extractability Grader - AI Answer Block Analysis | AI Visibility Platform',
    description:
      'Free tool to grade how well AI models can extract answers from your page. Analyzes heading hierarchy, FAQ patterns, and content structure.',
  },
  {
    path: '/reverse-engineer',
    title: 'Reverse Engineer | AI Visibility Platform',
    description:
      'Deconstruct how AI models build answers. Decompile, blueprint, diff, and simulate tools for AI content engineering.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Monitor what AI platforms and public sources say about your brand. Detect misrepresentations, track accuracy over time, and protect brand integrity.',
  },
  {
    path: '/blogs/cannot-access-before-initialization-react-vite-production-tdz-fix',
    title:
      'Cannot Access Before Initialization - React + Vite Production TDZ Fix | AI Visibility Blogs',
    description:
      'How to diagnose and fix the ReferenceError: Cannot access variable before initialization in React + Vite production builds caused by temporal dead zone issues.',
    ogType: 'article',
  },
  {
    ...
    description:
      'Learn how Model Context Protocol integrations let AI agents run visibility audits directly from your IDE, automating the audit-to-fix cycle.',
    ogType: 'article',
  },
  {
    path: '/blogs/team-workspace-aivis-the-shared-audit-layer-builders-have-been-missing',
    title:
      'Team Workspace: The Shared Audit Layer Builders Have Been Missing | AI Visibility Blogs',
    description:
      'How AI Visibility team workspaces give agencies and engineering teams a shared audit feed, role-based access, and coordinated visibility tracking.',
    ogType: 'article',
  },
  {
    path: '/blogs/webmcp-third-party-tool-calling-aivis-the-headless-audit-engine',
    title:
      'WebMCP Third-Party Tool Calling: AI Visibility as a Headless Audit Engine | AI Visibility Blogs',
    description:
      'AI Visibility exposes MCP-compatible endpoints that turn it into a headless audit engine any AI agent can call for structured visibility data.',
    ogType: 'article',
  },
  {
    path: '/blogs/answer-engine-optimization-is-not-the-new-seoits-the-big-brother',
    title:
      'Answer Engine Optimization Is Not the New SEO - It Is the Big Brother | AI Visibility Blogs',
    description:
      'Why AEO supersedes traditional SEO and how AI answer engines evaluate content differently from search engine crawlers.',
    ogType: 'article',
  },
  {
    ...
    description:
      'A strategic guide for startups navigating SEO and AEO in 2026, covering AI visibility, citation readiness, and machine-legible content.',
    ogType: 'article',
  },
  {
    ...
    description:
      'How the traditional SaaS model is being disrupted by AI-first platforms and what it means for product builders shipping in 2026.',
    ogType: 'article',
  },
  {
  ...
  },
  {
    ...
    description:
      'Introducing the AI Visibility Starter tier: 15 scans per month, paid AI model, full recommendations with implementation code, PDF export, and shareable links — all for $15/month.',
    ogType: 'article',
  },
  {
  ...
  },
  {
    ...
    title:
      'Choosing the Right AI Visibility Plan: Observer vs Starter vs Alignment | AI Visibility Blogs',
    description:
      'A practical comparison of AI Visibility tiers — what each plan includes, who it is for, and how to decide which level of AI visibility auditing you need.',
    ogType: 'article',
  },
  {
    ...
    description:
      "Google migrated crawler IP range JSON files from /search/apis/ipranges/ to /crawling/ipranges/ and renamed googlebot.json to common-crawlers.json. The old URLs return 200 OK with no IP data. Here's the full breakdown and fix.",
    ogType: 'article',
  },
  {
    ...
    description:
      'Official partnership terms for referral and delivery partnerships with AiVIS.biz AI Visibility Audit.',
  },
  {
    path: '/conversational-query-playbook-2026',
    title: 'Conversational Query Playbook 2026 | AI Visibility',
    description:
      'Master conversational query optimization for AI answer engines. Practical playbook for structuring content that wins in dialogue-based search.',
  },
  {
    path: '/voice-search-ai-answer-optimization-2026',
    title: 'Voice Search & AI Answer Optimization 2026 | AI Visibility',
    description:
      'Optimize your content for voice search and AI answer engines. Strategy guide for spoken-query visibility in 2026.',
  },
  {
    path: '/keywords',
    title: 'Keyword Intelligence | AI Visibility',
    description:
      'AI-powered keyword intelligence. Discover which queries trigger AI citations and track your keyword visibility across answer engines.',
  },
  {
    path: '/competitors',
    title: 'Competitor Tracking | AI Visibility',
    description:
      'Track competitor AI visibility scores, structural gaps, and citation presence. Find opportunities to outperform rival brands.',
  },
  {
    path: '/citations',
    title: 'Citation Testing | AI Visibility',
    description:
      'Test whether AI models cite your brand. Run live citation checks against ChatGPT, Perplexity, Gemini, and Claude.',
  },
  {
    path: '/reports',
    title: 'Audit Reports | AI Visibility',
    description:
      'Access your AI visibility audit reports. Export, share, and track score trends over time.',
  },
  {
    path: '/analytics',
    title: 'Analytics & Score Trends | AI Visibility',
    description:
      'Track your AI visibility score history, trends, and performance analytics over time.',
  },
  {
    path: '/niche-discovery',
    title: 'Niche Discovery | AI Visibility',
    description:
      'Discover untapped niches and content opportunities where AI models lack authoritative sources.',
  },
  {
    path: '/mcp',
    title: 'MCP Console | AI Visibility',
    description:
      'Model Context Protocol console. Connect AiVIS.biz audits to your development workflow via MCP integration.',
  },
  {
    path: '/gsc',
    title: 'Google Search Console Analysis | AiVIS.biz',
    description:
      'Analyze your Google Search Console data through an AI visibility lens. Identify gaps between traditional SEO and AI readiness.',
  },
  {
    path: '/referrals',
    title: 'Referral Program | AiVIS.biz',
    description:
      'Earn rewards by referring others to AiVIS.biz. Track your referral links, conversions, and earnings.',
  },
  {
    path: '/team',
    title: 'Team Workspace | AiVIS.biz',
    description:
      'Manage your team workspace. Invite members, assign roles, and collaborate on AI visibility audits.',
  },
  {
    path: '/badge',
    title: 'AiVIS.biz Dofollow Backlink Badge | Embed & Track',
    description:
      'Add a trackable dofollow backlink badge to your website footer. Earn SEO link equity and track impressions, clicks, and referrer domains in real time.',
  },
  // ── 100 Keyword SEO Pages (5 clusters × 20 pages) ────────────────────────
  // Platforms cluster
  {
    path: '/platforms/wordpress',
    title: 'WordPress AI Visibility Audit | AiVIS.biz',
    description:
  ...
  },
  {
    ...
    title: 'Shopify AI Visibility Audit | AiVIS.biz',
    description:
  ...
  {
    path: '/platforms/wix',
    title: 'Wix AI Visibility Audit | AiVIS.biz',
    description:
      "Find out why AI models can't cite your Wix site. Audit JavaScript rendering, schema, and crawl signals for Wix.",
  },
  {
    path: '/platforms/squarespace',
    title: 'Squarespace AI Visibility Audit | AiVIS.biz',
    description:
  ...
  {
    path: '/platforms/webflow',
    title: 'Webflow AI Visibility Audit | AiVIS.biz',
    description:
  ...
  {
    path: '/platforms/next-js',
    title: 'Next.js AI Visibility Audit | AiVIS.biz',
    description:
  ...
  {
    path: '/platforms/gatsby',
    title: 'Gatsby AI Visibility Audit | AiVIS.biz',
    description:
  ...
  },
  {
    ...
    title: 'Drupal AI Visibility Audit | AiVIS.biz',
    description:
  ...
  },
  {
    ...
    title: 'Magento AI Visibility Audit | AiVIS.biz',
    description:
  ...
  },
  {
    ...
    title: 'BigCommerce AI Visibility Audit | AiVIS.biz',
    description:
  ...
  {
    path: '/platforms/cargo',
    title: 'Cargo.site AI Visibility Audit | AiVIS.biz',
    description:
      'Audit your Cargo portfolio site for AI visibility. Discover rendering issues, missing schema, and crawl gaps.',
  },
  {
    path: '/platforms/notion-sites',
    title: 'Notion Sites AI Visibility Audit | AiVIS.biz',
    description:
  ...
  {
    path: '/platforms/carrd',
    title: 'Carrd AI Visibility Audit | AiVIS.biz',
    description:
  ...
  {
    path: '/platforms/react-spa',
    title: 'React SPA AI Visibility Audit | AiVIS.biz',
    description:
  ...
  // Problems cluster
  {
    path: '/problems/why-ai-cant-read-my-site',
    title: "Why AI Can't Read My Website | AiVIS.biz",
    description:
  ...
  {
    path: '/problems/missing-structured-data',
    title: 'Missing Structured Data Kills AI Citations | AiVIS.biz',
    description:
      "No JSON-LD or schema markup? AI models can't properly cite or attribute your content. Learn what structured data AI needs.",
  },
  {
    path: '/problems/javascript-rendering-blocks-ai',
    title: 'JavaScript Rendering Blocks AI Crawlers | AiVIS.biz',
    description:
      "AI crawlers don't execute JavaScript. If your site renders client-side, your content is invisible to AI models.",
  },
  {
    path: '/problems/no-schema-markup',
    title: 'No Schema Markup Detected on Your Site | AiVIS.biz',
    description:
  ...
  {
    path: '/problems/broken-open-graph',
    title: 'Broken Open Graph Tags Hurt AI Visibility | AiVIS.biz',
    description:
      'Broken or missing Open Graph tags prevent AI models from classifying and displaying your content correctly.',
  },
  {
    path: '/problems/missing-meta-descriptions',
    title: 'Missing Meta Descriptions Block AI Citations | AiVIS.biz',
    description:
      'Pages without meta descriptions force AI models to auto-generate summaries, often inaccurately.',
  },
  {
    path: '/problems/thin-content',
    title: 'Thin Content Kills AI Citation Chances | AiVIS.biz',
    description:
      'Thin pages with minimal content are skipped by AI models for citations. Learn the minimum content depth for AI visibility.',
  },
  {
    path: '/problems/duplicate-content',
    title: 'Duplicate Content Confuses AI Models | AiVIS.biz',
    description:
      'Duplicate content across your site forces AI models to choose between versions, often citing neither.',
  },
  {
    path: '/problems/slow-page-load',
    title: 'Slow Page Load Hurts AI Crawler Access | AiVIS.biz',
    description:
      'AI crawlers timeout on slow pages. If your server takes too long to respond, AI models skip you entirely.',
  },
  {
    path: '/problems/blocked-by-robots-txt',
    title: "Blocked by robots.txt - AI Can't Crawl You | AiVIS.biz",
    description:
      'Your robots.txt may be blocking GPTBot, ClaudeBot, and other AI crawlers without you realizing it.',
  },
  {
    path: '/problems/no-canonical-urls',
    title: "No Canonical URLs Set - AI Can't Determine Authority | AiVIS.biz",
    description:
      'Without canonical URLs, AI models see duplicates everywhere. Set canonicals to tell AI which page is authoritative.',
  },
  {
    path: '/problems/missing-sitemap',
    title: 'Missing or Broken Sitemap Hurts AI Discovery | AiVIS.biz',
    description: 'Without a valid XML sitemap, AI crawlers may miss important pages on your site.',
  },
  {
    path: '/problems/no-llms-txt',
    title: "No llms.txt File - AI Models Don't Know Your Site | AiVIS.biz",
    description:
      "The llms.txt standard lets you describe your site directly to AI models. Without it, you're leaving context on the table.",
  },
  {
    path: '/problems/poor-heading-structure',
    title: 'Poor Heading Structure Confuses AI Parsing | AiVIS.biz',
    description:
  ...
  {
    path: '/problems/images-without-alt-text',
    title: 'Images Without Alt Text - Invisible to AI | AiVIS.biz',
    description:
      'AI models rely on alt text to understand images. Missing alt attributes make your visual content completely invisible.',
  },
  {
    path: '/problems/no-author-attribution',
    title: "No Author Attribution - AI Can't Verify Expertise | AiVIS.biz",
    description:
      'Content without author attribution lacks the trust signal AI models need for citations.',
  },
  {
    path: '/problems/missing-faq-schema',
    title: 'Missing FAQ Schema - Your Q&A Is Invisible to AI | AiVIS.biz',
    description:
  ...
  {
    path: '/problems/broken-internal-links',
    title: 'Broken Internal Links Hurt AI Crawling | AiVIS.biz',
    description:
  ...
  {
    path: '/problems/no-hreflang-tags',
    title: "No Hreflang Tags - AI Can't Route Multi-Language Content | AiVIS.biz",
    description:
      'Without hreflang tags, AI models may cite the wrong language version of your content.',
  },
  {
    path: '/problems/ai-hallucinating-about-my-brand',
    title: 'AI Is Hallucinating About My Brand | AiVIS.biz',
    description:
  ...
  // Problems Extended cluster (query-first, question-oriented pages)
  {
    ...
    title: "Why AI Doesn't Cite My SaaS and webApp — Diagnosis | AiVIS.biz",
    description:
      'AI answer engines skip your SaaS and webApp because they cannot extract (SPA-JS heavy site - bad for AI scrapinmg, ), trust, or attribute your content. Diagnose exactly why with an evidence-backed audit.',
  },
  {
    path: '/problems/how-to-fix-ai-search-visibility',
    title: 'How to Fix AI Search Visibility — Step-by-Step | AiVIS.biz',
    description:
      'Your site is invisible to AI answer engines. Follow this step-by-step diagnostic to identify extraction failures and fix them with evidence.',
  },
  {
    path: '/problems/why-chatgpt-ignores-my-site',
    title: 'Why ChatGPT Ignores My Site — Root Causes | AiVIS.biz',
    description:
      'ChatGPT does not cite your site even though you rank well in Google. Here is why, and what structural changes fix it.',
  },
  {
    path: '/problems/why-perplexity-doesnt-mention-my-brand',
    title: "Why Perplexity Doesn't Mention My Brand | AiVIS.biz",
    description:
      'Perplexity builds answers from extractable pages. If your brand is absent, the extraction pipeline cannot reach your content.',
  },
  {
    path: '/problems/how-to-get-cited-by-ai-models',
    title: 'How to Get Cited by AI Models — Evidence-Based Guide | AiVIS.biz',
    description:
      'AI citation is not luck. It requires crawl access, extractable structure, and attributable claims. Here is exactly how to earn it.',
  },
  {
    path: '/problems/why-ai-gives-wrong-information-about-my-company',
    title: 'Why AI Gives Wrong Information About My Company | AiVIS.biz',
    description:
      'AI models fabricate or misattribute facts about your company when they cannot find authoritative structured data to extract.',
  },
  {
    path: '/problems/how-to-audit-ai-answer-readiness',
    title: 'How to Audit AI Answer Readiness | AiVIS.biz',
    description:
      'A systematic audit checks whether AI crawlers can access, extract, and attribute your content. Here is the full methodology.',
  },
  {
    path: '/problems/why-google-ai-overview-skips-my-content',
    title: 'Why Google AI Overview Skips My Content | AiVIS.biz',
    description:
      'Google AI Overviews extract from pages with clear structure. If your content is skipped, the extraction signals are missing.',
  },
  {
    path: '/problems/how-to-make-website-ai-readable',
    title: 'How to Make Your Website AI-Readable | AiVIS.biz',
    description:
      'AI readability means your page can be crawled, parsed into structured representations, and attributed. Here is how to achieve all three.',
  },
  {
    path: '/problems/why-ai-misquotes-my-content',
    title: 'Why AI Misquotes My Content - Causes and Fixes | AiVIS.biz',
    description:
      'AI misquotes happen when extraction is partial or schema markup is ambiguous. Diagnose and fix the root causes.',
  },
  {
    path: '/problems/how-to-fix-entity-confusion-in-ai',
    title: 'How to Fix Entity Confusion in AI Results | AiVIS.biz',
    description:
      'AI models confuse your brand with others when entity signals are weak. Strengthen disambiguation with structured data.',
  },
  {
    path: '/problems/why-ai-attributes-my-content-to-competitors',
    title: 'Why AI Attributes My Content to Competitors | AiVIS.biz',
    description:
      'When your content lacks clear authorship and entity markup, AI models credit competitors instead. Here is how to fix attribution.',
  },
  {
    path: '/problems/how-to-optimize-for-ai-answer-engines',
    title: 'How to Optimize for AI Answer Engines | AiVIS.biz',
    description:
      'AI answer engines do not rank pages — they extract fragments. Optimization means making your content structurally extractable.',
  },
  {
    path: '/problems/why-structured-data-matters-for-ai-citations',
    title: 'Why Structured Data Matters for AI Citations | AiVIS.biz',
    description:
      'Structured data gives AI models the machine-readable signals they need to extract, verify, and cite your content accurately.',
  },
  {
    path: '/problems/how-to-test-if-ai-can-extract-your-content',
    title: 'How to Test If AI Can Extract Your Content | AiVIS.biz',
    description:
      'Run an extraction readiness audit to check whether AI models can access, parse, and attribute your pages.',
  },
  {
    path: '/problems/why-ai-search-gives-outdated-information',
    title: 'Why AI Search Gives Outdated Information About You | AiVIS.biz',
    description:
      'AI models serve stale answers when your freshness signals are weak or your content lacks temporal markup.',
  },
  {
    path: '/problems/how-to-fix-ai-extraction-failures',
    title: 'How to Fix AI Extraction Failures | AiVIS.biz',
    description:
      'AI extraction fails silently. Diagnose JavaScript rendering blocks, missing schema, and crawler access issues step by step.',
  },
  {
    path: '/problems/why-claude-cant-find-my-website',
    title: "Why Claude Can't Find My Website | AiVIS.biz",
    description:
      'Claude builds answers from extractable content. If your site is absent, crawl access or structural signals are blocking extraction.',
  },
  {
    path: '/problems/how-to-improve-ai-citation-readiness',
    title: 'How to Improve AI Citation Readiness | AiVIS.biz',
    description:
      'Citation readiness is measurable. Audit your crawl access, schema markup, entity clarity, and content extractability.',
  },
  {
    path: '/problems/why-ai-answers-ignore-small-businesses',
    title: 'Why AI Answers Ignore Small Businesses | AiVIS.biz',
    description:
      'Small businesses are invisible to AI answers not because of size but because of missing structural signals. Here is how to fix it.',
  },
  // Problems Raw cluster (frustrated-searcher query-bank pages)
  {
    path: '/problems/site-not-showing-in-chatgpt',
    title: 'My Site Is Not Showing in ChatGPT — Why & Fix | AiVIS.biz',
    description:
      'If your site is not appearing in ChatGPT answers, crawl access, rendering, or entity signals are blocking extraction. Diagnose with an evidence-backed audit.',
  },
  {
    path: '/problems/chatgpt-not-mentioning-my-website',
    title: 'ChatGPT Not Mentioning My Website — Root Causes | AiVIS.biz',
    description:
      'ChatGPT skips sites with weak entity signals, blocked crawlers, or thin content. Find out exactly why with a BRAG evidence audit.',
  },
  {
    path: '/problems/ai-ignores-my-website-content',
    title: 'AI Ignores My Website Content — Diagnosis Guide | AiVIS.biz',
    description:
      'When AI models ignore your content, extraction barriers are present. Identify JavaScript rendering blocks, missing schema, and crawler denials.',
  },
  {
    path: '/problems/website-never-appears-in-ai-answers',
    title: 'Website Never Appears in AI Answers | AiVIS.biz',
    description:
      'Systematic absence from AI answers signals a gating block. Audit robots.txt, rendering, and schema to find the root cause.',
  },
  {
    path: '/problems/content-not-used-by-ai',
    title: 'My Content Is Not Being Used by AI | AiVIS.biz',
    description:
      'AI models skip content that lacks structure, attribution, and crawl access. Run an evidence-backed audit to find what is blocking extraction.',
  },
  {
    path: '/problems/chatgpt-gets-my-site-wrong',
    title: 'ChatGPT Gets My Site Wrong — Fix AI Misrepresentation | AiVIS.biz',
    description:
      'Inaccurate AI summaries stem from weak entity signals and stale training data. Correct them with authoritative structured data at the source.',
  },
  {
    path: '/problems/ai-summarizing-my-site-incorrectly',
    title: 'AI Is Summarizing My Site Incorrectly | AiVIS.biz',
    description:
      'AI summaries reflect what the model could extract. Fix incorrect AI summaries by strengthening entity clarity and structured data.',
  },
  {
    path: '/problems/ai-not-picking-up-my-pages',
    title: 'AI Not Picking Up My Pages — Extraction Failures | AiVIS.biz',
    description:
      'Pages that AI models do not pick up are failing at crawl access, rendering, or schema. Identify the failure layer with an evidence audit.',
  },
  {
    path: '/problems/how-chatgpt-decides-what-websites-to-use',
    title: 'How ChatGPT Decides What Websites to Use | AiVIS.biz',
    description:
      'ChatGPT selects sources based on crawl access, extractability, entity attribution, and content specificity. Learn the exact decision logic.',
  },
  {
    path: '/problems/how-ai-tools-choose-sources',
    title: 'How AI Tools Choose Which Sources to Cite | AiVIS.biz',
    description:
      'AI tools select citable sources from pages that are accessible, structured, and attributable. Understand the full selection criteria.',
  },
  {
    path: '/problems/why-some-sites-get-cited-not-mine',
    title: 'Why Some Sites Get Cited by AI and Mine Does Not | AiVIS.biz',
    description:
      'Cited sites have accessible crawlers, complete structured data, and specific attributable content. Compare your signals to theirs.',
  },
  {
    path: '/problems/what-makes-website-visible-to-ai-search',
    title: 'What Makes a Website Visible to AI Search | AiVIS.biz',
    description:
      'AI search visibility requires four conditions: crawler access, structured extraction, entity attribution, and content depth. Audit all four.',
  },
  {
    path: '/problems/how-ai-models-read-websites',
    title: 'How AI Models Read Websites — Technical Breakdown | AiVIS.biz',
    description:
      'AI models read raw HTML, not rendered browser pages. Understand the full five-step extraction pipeline and what blocks each stage.',
  },
  {
    path: '/problems/how-to-get-site-mentioned-in-chatgpt',
    title: 'How to Get Your Site Mentioned in ChatGPT | AiVIS.biz',
    description:
      'Getting cited in ChatGPT requires crawl access, structured data, and extractable content. Here is the complete path from invisible to cited.',
  },
  {
    path: '/problems/how-to-make-ai-cite-my-website',
    title: 'How to Make AI Cite My Website | AiVIS.biz',
    description:
      'AI citation is earned through structural correctness. Fix the four gating conditions and your site becomes a citable source.',
  },
  {
    path: '/problems/how-to-make-content-show-in-ai-results',
    title: 'How to Make Your Content Show in AI Results | AiVIS.biz',
    description:
      'AI results pull from extractable, attributed pages. Structure your content for AI extraction with schema, headings, and clear entity signals.',
  },
  {
    path: '/problems/how-to-structure-content-for-ai-models',
    title: 'How to Structure Content for AI Models | AiVIS.biz',
    description:
      'AI models extract from semantically structured content. Use headings, FAQ schema, and specific claims to maximize extraction probability.',
  },
  {
    path: '/problems/seo-vs-ai-search-difference',
    title: 'SEO vs AI Search — What Is Actually Different | AiVIS.biz',
    description:
      'SEO and AI search optimization are not the same discipline. Understand the structural differences and which signals matter for each.',
  },
  {
    path: '/problems/why-ai-search-replacing-google-clicks',
    title: 'Why AI Search Is Replacing Google Clicks | AiVIS.biz',
    description:
      'AI answer engines eliminate the click by synthesizing answers inline. Understand the shift and how to maintain visibility without the click.',
  },
  {
    path: '/problems/saas-show-up-in-chatgpt',
    title: 'How to Make My SaaS Show Up in ChatGPT | AiVIS.biz',
    description:
      'SaaS products need entity clarity, Organization schema, and specific use-case content to appear in AI product recommendation answers.',
  },
  {
    path: '/problems/startup-not-mentioned-in-ai-answers',
    title: 'My SaaS Is Not Mentioned in AI Answers | AiVIS.biz',
    description:
      'New startups are invisible to AI because entity signals are absent. Build brand recognition through structured data and consistent entity markup.',
  },
  {
    path: '/problems/why-chatgpt-uses-some-sites-not-mine',
    title: 'Why ChatGPT Uses Some Sites and Not Mine | AiVIS.biz',
    description:
      'ChatGPT citation is structural, not random. The sites that get used have accessible crawlers, complete schema, and specific content.',
  },
  {
    path: '/problems/how-to-know-if-ai-can-read-my-website',
    title: 'How to Know If AI Can Read My Website | AiVIS.biz',
    description:
      'Test your site for AI readability with View Source, robots.txt inspection, and a structured evidence audit.',
  },
  {
    path: '/problems/why-ai-rewrites-instead-of-linking',
    title: 'Why AI Rewrites My Content Instead of Linking to It | AiVIS.biz',
    description:
      'AI systems rewrite content they cannot attribute. Add Organization schema and author markup to earn citation links instead of paraphrases.',
  },
  {
    path: '/problems/how-to-fix-content-ai-misunderstands',
    title: 'How to Fix The Content that AI Misunderstands | AiVIS.biz',
    description:
      'AI misunderstands content when it lacks structure and specific claims. Restructure with targeted schema and heading-segmented facts.',
  },
  // Signals cluster
  {
    path: '/signals/json-ld',
    title: 'JSON-LD Structured Data for AI Visibility | AiVIS.biz',
    description:
      'JSON-LD is the structured data format AI models prefer. Learn how to implement it for maximum AI citation potential.',
  },
  {
    path: '/signals/open-graph',
    title: 'Open Graph Tags for AI Answer Engines | AiVIS.biz',
    description:
      'Open Graph tags help AI models classify and display your content. Learn which OG tags matter most for AI citations.',
  },
  {
    path: '/signals/meta-descriptions',
    title: 'Meta Descriptions for AI Visibility | AiVIS.biz',
    description:
      'Write meta descriptions that help AI models accurately summarize and cite your content.',
  },
  {
    path: '/signals/canonical-urls',
    title: 'Canonical URLs and AI Citation Accuracy | AiVIS.biz',
    description:
      'Canonical URLs tell AI models which version of your content is authoritative. Essential for deduplication and citation accuracy.',
  },
  {
    path: '/signals/robots-txt',
    title: 'robots.txt Configuration for AI Crawlers | AiVIS.biz',
    description: 'Configure your robots.txt to control which AI crawlers can access your content.',
  },
  {
    path: '/signals/sitemap-xml',
    title: 'XML Sitemap Optimization for AI Discovery | AiVIS.biz',
    description:
      'Your XML sitemap is the roadmap AI crawlers use to discover your content. Optimize it for AI-specific discovery patterns.',
  },
  {
    path: '/signals/llms-txt',
    title: 'llms.txt - Describe Your Site for AI Models | AiVIS.biz',
    description:
      'llms.txt is a new standard for describing your site directly to AI language models. Learn how to create and deploy one.',
  },
  {
    path: '/signals/schema-org',
    title: 'Schema.org Markup for AI Engines | AiVIS.biz',
    description:
      'Schema.org provides the vocabulary AI models use to understand your content. Learn which types matter most for AI citations.',
  },
  {
    path: '/signals/heading-hierarchy',
    title: 'Heading Hierarchy (H1-H6) for AI Parsing | AiVIS.biz',
    description:
      'AI models use heading hierarchy to understand content structure. Get your H1-H6 tags right for better AI citations.',
  },
  {
    path: '/signals/page-speed',
    title: 'Page Speed and AI Crawler Access | AiVIS.biz',
    description:
      'AI crawlers timeout on slow pages. Optimize server response time to ensure crawlers can access and parse your content.',
  },
  {
    path: '/signals/mobile-responsiveness',
    title: 'Mobile-First AI Indexing | AiVIS.biz',
    description:
      'AI crawlers often use mobile user-agents. Ensure your mobile experience delivers the same content and structure as desktop.',
  },
  {
    path: '/signals/internal-linking',
    title: 'Internal Link Architecture for AI Discovery | AiVIS.biz',
    description:
      'AI crawlers discover content by following internal links. Build a link architecture that guides AI to your most important pages.',
  },
  {
    path: '/signals/content-freshness',
    title: 'Content Freshness Signals for AI | AiVIS.biz',
    description:
      'AI models prioritize fresh content. Learn which freshness signals matter and how to maintain them for AI citation advantage.',
  },
  {
    path: '/signals/author-entity',
    title: 'Author Entity Markup for AI Trust | AiVIS.biz',
    description:
      'Author entity markup connects content to verified identities. AI models use author signals for trust scoring and citation ranking.',
  },
  {
    path: '/signals/faq-schema',
    title: 'FAQ Schema for AI Answer Placement | AiVIS.biz',
    description:
      'FAQ schema is the highest-impact signal for AI answer inclusion. Mark up your Q&A content for direct extraction by AI models.',
  },
  {
    path: '/signals/breadcrumb-schema',
    title: 'Breadcrumb Schema for AI Navigation | AiVIS.biz',
    description:
      'Breadcrumb schema helps AI models understand your site hierarchy and content relationships. Easy to add, high impact.',
  },
  {
    path: '/signals/alt-text',
    title: 'Image Alt Text for AI Understanding | AiVIS.biz',
    description:
      "AI language models can't see images - they read alt text. Write descriptive alt attributes for AI comprehension and citations.",
  },
  {
    path: '/signals/hreflang',
    title: 'Hreflang for Multi-Language AI Visibility | AiVIS.biz',
    description:
      'Hreflang tags direct AI crawlers to the right language version of your content. Essential for multilingual AI visibility.',
  },
  {
    path: '/signals/content-length',
    title: 'Content Depth and Completeness for AI | AiVIS.biz',
    description:
      'AI models prioritize comprehensive content. Learn the content depth signals that improve AI citation likelihood.',
  },
  {
    path: '/signals/trust-signals',
    title: 'Trust and Authority Signals for AI | AiVIS.biz',
    description:
      'AI models assess trustworthiness before citing. Build the authority signals that make your content citation-worthy.',
  },
  // Industries cluster
  {
    path: '/industries/saas',
    title: 'AI Visibility for SaaS Companies | AiVIS.biz',
    description:
      'SaaS companies need AI visibility to appear in product recommendation answers. Audit your site for AI-ready structured data.',
  },
  {
    path: '/industries/ecommerce',
    title: 'AI Visibility for E-Commerce Stores | AiVIS.biz',
    description:
      'E-commerce sites need Product schema and structured data to appear in AI shopping recommendations.',
  },
  {
    path: '/industries/healthcare',
    title: 'AI Visibility for Healthcare Organizations | AiVIS.biz',
    description:
      'Healthcare sites need E-E-A-T signals and MedicalOrganization schema for AI visibility.',
  },
  {
    path: '/industries/legal',
    title: 'AI Visibility for Law Firms | AiVIS.biz',
    description:
      'Law firms need AI visibility to appear in legal question answers. Optimize structured data and practice area content for AI citations.',
  },
  {
    path: '/industries/real-estate',
    title: 'AI Visibility for Real Estate | AiVIS.biz',
    description:
      'Real estate agencies need AI visibility for property-related queries. Optimize listings, agent profiles, and neighborhood content.',
  },
  {
    path: '/industries/finance',
    title: 'AI Visibility for Financial Services | AiVIS.biz',
    description:
      'Financial services need strong trust signals for AI visibility. Audit your site for YMYL compliance and finance-specific structured data.',
  },
  {
    path: '/industries/education',
    title: 'AI Visibility for Education Websites | AiVIS.biz',
    description:
      'Educational institutions need AI visibility for program discovery. Optimize course pages, faculty profiles, and educational content.',
  },
  {
    path: '/industries/restaurants',
    title: 'AI Visibility for Restaurants | AiVIS.biz',
    description:
      'Restaurants need AI visibility for best restaurant and where to eat queries. Optimize menu data, reviews, and local schema.',
  },
  {
    path: '/industries/travel',
    title: 'AI Visibility for Travel & Hospitality | AiVIS.biz',
    description:
      'Travel businesses need AI visibility for destination and accommodation queries. Optimize structured data for AI travel recommendations.',
  },
  {
    path: '/industries/automotive',
    title: 'AI Visibility for Automotive Businesses | AiVIS.biz',
    description:
      'Auto dealers and service providers need AI visibility for vehicle and service queries. Optimize inventory and service schema.',
  },
  {
    path: '/industries/insurance',
    title: 'AI Visibility for Insurance Companies | AiVIS.biz',
    description:
      'Insurance providers need AI visibility for coverage and policy questions. Optimize structured data for AI-answered insurance queries.',
  },
  {
    path: '/industries/consulting',
    title: 'AI Visibility for Consulting Firms | AiVIS.biz',
    description:
      'Consulting firms need AI visibility to appear in expertise-based recommendations. Build authority through structured data.',
  },
  {
    path: '/industries/nonprofit',
    title: 'AI Visibility for Nonprofit Organizations | AiVIS.biz',
    description:
      'Nonprofits need AI visibility for donation, volunteer, and cause-related queries. Optimize structured data for AI discovery.',
  },
  {
    path: '/industries/manufacturing',
    title: 'AI Visibility for Manufacturing Companies | AiVIS.biz',
    description:
      'Manufacturing companies need AI visibility for B2B discovery. Optimize product catalogs and capability pages for AI citations.',
  },
  {
    path: '/industries/recruitment',
    title: 'AI Visibility for Recruitment Agencies | AiVIS.biz',
    description:
      'Recruitment agencies need AI visibility for hiring-related queries. Optimize job listings and service pages for AI discovery.',
  },
  {
    path: '/industries/media',
    title: 'AI Visibility for Media & Publishing | AiVIS.biz',
    description:
      'Media companies need AI visibility to maintain citation share. Optimize article markup, author entities, and publisher schema.',
  },
  {
    path: '/industries/fitness',
    title: 'AI Visibility for Fitness & Wellness | AiVIS.biz',
    description:
      'Fitness and wellness businesses need AI visibility for health and fitness queries. Optimize structured data for AI recommendations.',
  },
  {
    path: '/industries/crypto',
    title: 'AI Visibility for Crypto & Web3 | AiVIS.biz',
    description:
      'Crypto and Web3 projects need AI visibility for token, protocol, and DeFi queries. Build trust signals for AI citations.',
  },
  {
    path: '/industries/agencies',
    title: 'AI Visibility for Marketing Agencies | AiVIS.biz',
    description:
      'Marketing agencies need AI visibility for service discovery queries. Optimize your agency site for AI-powered client acquisition.',
  },
  {
    path: '/industries/local-business',
    title: 'AI Visibility for Local Businesses | AiVIS.biz',
    description:
      'Local businesses need AI visibility for near me queries. Optimize LocalBusiness schema, reviews, and service area data.',
  },
  // Compare cluster
  {
    path: '/compare/aivis-vs-moz',
    title: 'AiVIS.biz vs Moz: AI Visibility vs Traditional SEO | AiVIS.biz',
    description:
  ...
  {
    path: '/compare/aivis-vs-surfer',
    title: 'AiVIS.biz vs Surfer SEO: Structural Audit vs Content Optimization | AiVIS.biz',
    description:
  ...
  {
    path: '/compare/aivis-vs-clearscope',
    title: 'AiVIS.biz vs Clearscope: Machine Readability vs Content Grading | AiVIS.biz',
    description:
  ...
  {
    path: '/compare/aivis-vs-marketmuse',
    title: 'AiVIS.biz vs MarketMuse: Citation Readiness vs Content Strategy | AiVIS.biz',
    description:
  ...
  {
    path: '/compare/aivis-vs-frase',
    title: 'AiVIS.biz vs Frase: Structural Audit vs Answer-Focused Writing | AiVIS.biz',
    description:
      'Compare AiVIS.biz and Frase. Frase generates content briefs for answer-focused writing; AiVIS.biz audits whether AI models can read and cite your pages.',
  },
  {
    path: '/compare/aivis-vs-brightedge',
    title: 'AiVIS.biz vs BrightEdge: AI Citation Audit vs Enterprise SEO | AiVIS.biz',
    description:
  ...
  {
    path: '/compare/aivis-vs-conductor',
    title: 'AiVIS.biz vs Conductor: AI Visibility vs Organic Marketing | AiVIS.biz',
    description:
  ...
  {
    path: '/compare/aivis-vs-searchmetrics',
    title: 'AiVIS.biz vs Searchmetrics: AI Audit vs Search Experience Platform | AiVIS.biz',
    description:
  ...
  {
    path: '/compare/aivis-vs-botify',
    title: 'AiVIS.biz vs Botify: AI Citation vs Technical SEO Crawling | AiVIS.biz',
    description:
  ...
  {
    path: '/compare/aivis-vs-lumar',
    title: 'AiVIS.biz vs Lumar: AI Visibility vs Website Intelligence | AiVIS.biz',
    description:
  ...
  {
    path: '/compare/aivis-vs-sitebulb',
    title: 'AiVIS.biz vs Sitebulb: AI Visibility vs Desktop SEO Crawler | AiVIS.biz',
    description:
      'Compare AiVIS.biz with Sitebulb. Sitebulb is a desktop SEO crawler; AiVIS.biz audits whether AI answer engines can parse and cite your content.',
  },
  {
    path: '/compare/aivis-vs-screaming-frog',
    title: 'AiVIS.biz vs Screaming Frog: AI Visibility vs SEO Spider | AiVIS.biz',
    description:
  ...
  {
    path: '/compare/aivis-vs-serpstat',
    title: 'AiVIS.biz vs Serpstat: AI Visibility vs Multi-Tool SEO Platform | AiVIS.biz',
    description:
  ...
  {
    path: '/compare/aivis-vs-se-ranking',
    title: 'AiVIS.biz vs SE Ranking: AI Audit vs All-in-One SEO | AiVIS.biz',
    description:
      'Compare AiVIS.biz with SE Ranking. SE Ranking is an all-in-one SEO platform; AiVIS.biz audits whether AI answer engines can parse and cite your pages.',
  },
  {
    path: '/compare/aivis-vs-mangools',
    title: 'AiVIS.biz vs Mangools: AI Visibility vs Beginner-Friendly SEO | AiVIS.biz',
    description:
  ...
  {
    path: '/compare/aivis-vs-ubersuggest',
    title: 'AiVIS.biz vs Ubersuggest: AI Visibility vs Keyword Discovery | AiVIS.biz',
    description:
      'Compare AiVIS.biz with Ubersuggest. Ubersuggest helps discover keywords; AiVIS.biz audits whether AI answer engines can parse and cite your content.',
  },
  {
    path: '/compare/aivis-vs-chatgpt-search',
    title: 'AiVIS.biz vs ChatGPT Search: Auditing vs Searching | AiVIS.biz',
    description:
  ...
  {
    path: '/compare/aivis-vs-perplexity-pages',
    title: 'AiVIS.biz vs Perplexity Pages: Auditing vs Publishing | AiVIS.biz',
    description:
      'Perplexity Pages lets you publish AI-curated content. AiVIS.biz audits whether AI engines can cite YOUR existing content.',
  },
  {
    path: '/compare/aivis-vs-alli-ai',
    title: 'AiVIS.biz vs Alli AI: Diagnostic Audit vs Automated SEO Changes | AiVIS.biz',
    description:
      'Compare AiVIS.biz with Alli AI. Alli AI automates on-page SEO changes; AiVIS.biz audits whether AI answer engines can parse and cite your content.',
  },
  {
    path: '/compare/aivis-vs-seo-powersuite',
    title: 'AiVIS.biz vs SEO PowerSuite: AI Visibility vs Desktop SEO Suite | AiVIS.biz',
    description:
      'Compare AiVIS.biz with SEO PowerSuite. SEO PowerSuite is a desktop SEO toolkit; AiVIS.biz audits whether AI answer engines can parse and assemble your content in zero-click scenarios.',
  },

  // ── Taxonomy: About layer ──────────────────────────────────────────────
  {
    path: '/about-aivis',
    title: 'About AiVIS — Canonical Entity Definition | AiVIS.biz',
    description:
      'AiVIS is an evidence-backed AI visibility auditing system. It evaluates whether AI answer engines can read, extract, and correctly cite web content using the Cite Ledger, BRAG evidence trails, and deterministic SSFR rules.',
    ogType: 'article',
  },
  {
    path: '/what-is-aivis',
    title: 'What Is AiVIS — AI Visibility Auditing Explained | AiVIS.biz',
    description:
      'AiVIS audits whether AI answer engines like ChatGPT, Perplexity, Claude, and Gemini can correctly read, extract, and cite your web content. Scores are grounded in the Cite Ledger evidence chain.',
  },
  {
    path: '/why-aivis-exists',
    title: 'Why AiVIS Exists — The Problem AiVIS Solves | AiVIS.biz',
    description:
      'AI answer engines hallucinate citations, merge distinct entities, and assign scores without traceable evidence. AiVIS exists to make AI visibility measurable, reproducible, and auditable.',
  },

  // ── Taxonomy: Methodology layer ────────────────────────────────────────
  {
    path: '/methodology/cite-ledger',
    title: 'Cite Ledger — How AiVIS Records Evidence | AiVIS.biz',
    description:
  ...
  },
  {
    ...
    title: 'What Is CITE LEDGER — Structured Attribution System by AiVIS | AiVIS.biz',
    description:
      'CITE LEDGER is a structured attribution system developed by AiVIS that tracks how AI models interpret, reference, and cite web content across answer engines like ChatGPT, Perplexity, Google AI Overviews, and Claude.',
    ogType: 'article',
  },
  {
    ...
    title: 'Triple-Check Protocol — Multi-Model AI Verification | AiVIS.biz',
    description:
      'The Triple-Check Protocol runs three independent AI models in sequence: deep analysis, peer critique with bounded score adjustment, and a validation gate that confirms or overrides the final score.',
  },
  {
    path: '/methodology/brag-evidence-trails',
    title: 'BRAG Evidence Trails — Verifiable Finding Identity | AiVIS.biz',
    description:
      'Every AiVIS finding receives a BRAG ID generated deterministically from its source and content hash. The BRAG trail links the finding to its evidence, the Cite Ledger entry, and the pipeline stage that produced it.',
  },
  {
    path: '/methodology/entity-resolution-model',
    title: 'Entity Resolution Model — Stable AI Identity | AiVIS.biz',
    description:
  ...
  // ── Taxonomy: Evidence layer ───────────────────────────────────────────
  {
    ...
    title: 'Evidence Ledger Index — Entry Type Catalogue | AiVIS.biz',
    description:
      'Browse the six Cite Ledger entry types by pipeline stage: scrape observations, evidence extractions, rule evaluations, AI analysis findings, BRAG gate decisions, and finalization records.',
  },
  {
    path: '/evidence/citation-reports',
    title: 'Citation Reports — Grouped Evidence Outputs | AiVIS.biz',
    description:
      'Citation reports group Cite Ledger evidence by outcome: correctly cited content, missing citations, and entity merge detections. Each report traces back through BRAG trails to the originating finding.',
  },
  {
    path: '/evidence/drift-analysis',
    title: 'Drift Analysis — Attribution Stability Over Time | AiVIS.biz',
    description:
      'Drift analysis measures four types of attribution instability: citation decay, entity substitution, evidence structural drift, and score regression. Each metric is computed from sequential Cite Ledger snapshots.',
  },
  {
    path: '/evidence/query-results-log',
    title: 'Query Results Log — Raw SERP and AI Traces | AiVIS.biz',
    description:
      'The Query Results Log stores raw SERP snapshots and AI answer traces with no interpretation layer. Each entry records query, engine, raw response, rank position, cited URL, entity match, and Cite Ledger reference.',
  },
];
...
/**
 * Generate Cite Ledger JSON structure for embedding in page
 * This makes the citation evidence system visible to machines.
 * @param {string} canonicalUrl - The full canonical URL of the page
    ...
    buildExtraHead(canonicalUrl, route) {
      return [
            ...
            parts: [
              {
                ...
                url: 'https://aivis.biz/api-docs',
                description:
                  'Developer reference for audits, analytics, evidence and validation endpoints.',
              },
              {
                name: 'Score Fix',
                url: 'https://aivis.biz/score-fix',
                description:
                  'Remediation workflow that turns findings into implementation-ready fixes.',
              },
              {
                name: 'Help Center',
                url: 'https://aivis.biz/help',
                description: 'Support documentation for audits, billing, and platform operations.',
              },
            ],
          })
        ),
        jsonLdScript(
          buildFaqSchema([
            {
              question: 'What does the AiVIS.biz integrations route explain?',
              answer:
                'It explains how audits connect to API keys, webhooks, scheduled rescans, and Auto Score Fix automation so teams can operationalize AI visibility work.',
            },
            {
              question: 'Are integrations purely marketing claims?',
              answer:
                'No. The page documents concrete endpoint checks, gating behavior, and configuration surfaces that map to actual product workflows.',
            },
            {
              question: 'Why does this route matter for AI readability?',
              answer:
                'It adds explicit system-level context about automation, event delivery, and API-driven usage that strengthens how machines interpret the product.',
            },
          ])
        ),
      ].join('\n');
      ...
      return [
        ...
        jsonLdScript(
          buildHowToSchema({
            ...
            description:
              'A quickstart for creating an API key, calling audit endpoints, scheduling tasks, white-labeling, and monitoring usage in AiVIS.biz.',
            steps: [
              {
                name: 'Create an API key:',
                text: 'Generate a workspace API key from the  user settings or feature panel with the scopes required for your integration.',
              },
              {
                name: 'Call audit or analytics endpoints:',
                text: 'Send Bearer-authenticated requests to AiVIS.biz API routes for audit listings, evidence payloads, analytics, and technical validation.',
              },
              {
                name: 'Handle production errors:',
                text: 'Respect 401, 403, and validation error responses so your automation can distinguish invalid keys, missing scopes, and unsafe targets.',
              },
              {
                name: 'Monitor usage and events:',
                text: 'Use metering endpoints and webhook delivery to prevent abuse and keep integrations observable and tier-safe for everyone over time.',
              },
            ],
          })
        ),
        jsonLdScript(
          buildFaqSchema([
            {
              question: 'What does the AiVIS.biz API expose and are they?',
              answer:
                'It exposes audit, analytics, evidence, usage, competitor, and page-validation endpoints intended for reporting, automation, and verification workflows.',
            },
            {
              question: 'How is authentication handled?',
              answer:
                'External integrations use workspace-scoped API keys with server-side scope and entitlement checks on every request.',
            },
            {
              question: 'Why does documentation help AI-machine readability?',
              answer:
                'Detailed and structured API documentation helps prove concrete platform or website/app capability, naming, permissions and operational behavior, which improves machine interpretation, authorization and trust of the platform, which fosters better and faster AI understanding and multi-platform mentions.',
            },
          ])
        ),
      ].join('\n');
    ...
    buildExtraHead(canonicalUrl, route) {
      return [
            ...
            items: [
              {
                name: 'AiVIS.biz',
                description:
                  'AI visibility auditing with evidence-backed scoring, citation testing, and score remediation.',
              },
              {
                name: 'Semrush',
                description: 'Traditional SEO suite with partial overlap on audits and monitoring.',
              },
              {
                name: 'Ahrefs',
                description:
                  'Backlink and SEO intelligence platform with limited AI visibility overlap.',
              },
              {
                name: 'Surfer SEO',
                description:
                  'Content optimization platform with partial overlap on on-page recommendations.',
              },
              {
                name: 'Clearscope',
                description:
                  'Content scoring product with limited support for AI citation readiness.',
              },
              {
                name: 'MarketMuse',
                description:
                  'Content planning tool with limited overlap on live AI visibility audits.',
              },
            ],
          })
        ),
        jsonLdScript(
          buildFaqSchema([
            {
              question: 'What is the purpose of the AiVIS.biz comparison page?',
              answer:
                'It explains how AiVIS.biz differs from traditional SEO and content tools by focusing on AI visibility, evidence quality, and citation readiness.',
            },
            {
              question: 'Does the page claim every competitor is identical?',
              answer:
                'No. It positions them by category and overlap level so readers can see which capabilities partially intersect and which are missing.',
            },
            {
              question: 'Why is comparison content useful for AI systems?',
              answer:
                'It clarifies category boundaries and differentiators, helping machines interpret AiVIS.biz as a distinct product within the broader search and content tooling landscape.',
            },
          ])
        ),
      ].join('\n');
    ...
    buildExtraHead(canonicalUrl, route) {
      return [
        ...
        jsonLdScript(
          buildFaqSchema([
            {
              question: 'What is Score Fix in AiVIS.biz?',
              answer:
                'Score Fix is the remediation workflow that turns audit findings into prioritized content, schema, proof, and internal-link changes.',
            },
            {
              question: 'Does Score Fix only describe problems?',
              answer:
                'No. It focuses on implementation targets and re-check guidance so teams can move from diagnosis to measurable improvement.',
            },
            {
              question: 'Why is Score Fix important for AI visibility?',
              answer:
                'Because better citations and extraction quality come from structural fixes, not from reports alone. Score Fix defines the changes that improve those outcomes.',
            },
          ])
        ),
      ].join('\n');
    ...
    buildExtraHead(canonicalUrl, route) {
      return [
            ...
            parts: [
              {
                ...
                description: 'Workflow guidance for audits, fixes, and rechecks.',
              },
              {
                name: 'FAQ',
                url: 'https://aivis.biz/faq',
                description: 'Frequently asked questions about AI visibility scoring and audits.',
              },
              {
                name: 'Pricing',
                url: 'https://aivis.biz/pricing',
                description:
                  'Plan and billing information for Observer, Alignment, Signal, and Score Fix.',
              },
              {
                name: 'Privacy',
                url: 'https://aivis.biz/privacy',
                description: 'Privacy and security information for the AiVIS.biz platform.',
              },
            ],
          })
        ),
        jsonLdScript(
          buildFaqSchema([
            {
              question: 'What kinds of questions does the AiVIS.biz Help Center answer?',
              answer:
                'It answers questions about audits, score interpretation, citations, competitor tracking, billing, privacy, and support workflows.',
            },
            {
              question: 'Why is the Help Center important for site understanding?',
              answer:
                'It gives machines and users direct definitions for product concepts, policies, and support paths that are otherwise spread across multiple pages.',
            },
            {
              question: 'Is the Help Center only for troubleshooting?',
              answer:
                'No. It also acts as platform documentation that explains how AiVIS.biz works and how key features connect.',
            },
          ])
        ),
      ].join('\n');
  ...
  '/compliance': {
    ...
    buildExtraHead(canonicalUrl, route) {
      return jsonLdScript(
        buildFaqSchema([
          {
            question: 'Is AiVIS.biz GDPR compliant?',
            answer:
              'AiVIS.biz follows GDPR-aligned practices including minimal data collection, encryption, user data export and deletion rights, and transparent retention policies.',
          },
          {
            question: 'Where is AiVIS.biz data stored?',
            answer:
              'Data is stored in managed PostgreSQL (Neon) with TLS encryption at rest and in transit. Infrastructure is hosted on Render.',
          },
          {
  ...
  '/workflow': {
    ...
    buildExtraHead(canonicalUrl, route) {
      return jsonLdScript(
        buildFaqSchema([
          {
            question: 'How do I turn an AiVIS.biz audit into a repeatable workflow?',
            answer:
              'Start with a baseline audit, implement Score Fix recommendations, then re-audit to measure progress. Repeat this cycle as your content changes.',
          },
          {
            question: 'How often should I re-audit my site?',
            answer:
              'Re-audit after implementing major content or technical changes, or at least monthly to track score trends against competitors.',
          },
          {
            question: 'What is the AiVIS.biz workflow loop?',
            answer:
              'Baseline audit, evidence-based remediation via Score Fix, re-audit validation, and ongoing competitor tracking — a continuous AI visibility operations cycle.',
          },
        ])
      );
    },
  ...
  '/server-headers': {
    ...
    buildExtraHead(canonicalUrl, route) {
      return jsonLdScript(
        buildFaqSchema([
          {
            question: 'What HTTP headers affect AI crawlability?',
            answer:
              'Cache-Control, Content-Type, security headers like CSP and HSTS, and server identification headers all influence how crawlers prioritize and trust your content.',
          },
          {
            question: 'How do I check my server headers?',
            answer:
              'Enter any public URL in the AiVIS.biz Server Headers tool. It fetches the response headers and evaluates cache, security, and content configuration.',
          },
          {
            question: 'Why do security headers matter for SEO?',
            answer:
              'Security headers like HSTS and CSP signal trustworthiness to crawlers. Sites with proper security posture may receive higher crawl priority and trust scores.',
          },
        ])
      );
    },
    ...
    buildExtraHead(canonicalUrl, route) {
      return [
        jsonLdScript(
          buildFaqSchema([
            {
              question: 'How do I contact AiVIS.biz support?',
              answer:
                'Use the in-app contact form or email support directly. The Help Center and FAQ also answer most common questions.',
            },
            {
              question: 'How do I manage my AiVIS.biz subscription?',
              answer:
                'Go to Settings to upgrade, downgrade, or cancel your plan. Billing is handled through Stripe with PCI-compliant payment processing.',
            },
            {
              question: 'What topics does AiVIS.biz support cover?',
              answer:
                'Audit interpretation, score questions, billing, team seats, API integrations, and technical troubleshooting.',
            },
          ])
        ),
      ].join('\n');
...
function contentToHtml(raw, limit = 2000) {
  ...
  for (const line of lines) {
    ...
    if (trimmed.startsWith('## ')) {
      ...
      parts.push(
        `<h3 style="font-size:18px;margin:18px 0 8px;">${escapeHtml(trimmed.slice(3))}</h3>`
      );
      ...
      parts.push(
        `<h4 style="font-size:16px;margin:14px 0 6px;">${escapeHtml(trimmed.slice(4))}</h4>`
      );
    } else if (trimmed.startsWith('- ') || trimmed.startsWith('* ')) {
      if (!inList) {
        parts.push('<ul style="margin:0;padding-left:20px;color:#374151;">');
        inList = true;
      }
...
function renderKeywordPageBody(route, canonicalUrl) {
  ...
  const hook = kwp.hook
    ? escapeHtml(kwp.hook)
    : escapeHtml(normalizeMetaDescription(route.description, 300));

  const sectionsHtml = (kwp.sections || [])
    .map((sec) => {
      const id = sec.heading.toLowerCase().replace(/[^a-z0-9]+/g, '-');
      const paras = sec.paragraphs
        .map((p) => `<p style="margin:0 0 12px;color:#374151;">${escapeHtml(p)}</p>`)
        .join('\n');
...
function prerenderHtml(route) {
  ...
  // LAYER 1: SEO & METADATA Layer (Canonical, Titles, Descriptions)
  // CRITICAL: Each page must self-canonicalize with its full unique URL
  // No homepage collapse. No query string normalization. Each route is discrete.
  // Rule: canonical = `https://aivis.biz${route.path}` (exceptions for intentional consolidation only)
  ...
  if (route.path.startsWith('/blogs/') && route.path !== '/blogs') {
    ...
    if (blogMeta) {
      ...
      const articleSchema = {
        ...
        datePublished: blogMeta.publishedAt ? `${blogMeta.publishedAt}T00:00:00Z` : BUILD_DATE,
        dateModified: BUILD_DATE,
        author: {
          '@type': 'Person',
      ...
      html = html.replace('</head>', `${jsonLdScript(articleSchema)}\n</head>`);
    }
  }
  ...
  // participates in the CITE LEDGER system and has evidence-backed signals.
...
function sitemapMeta(p) {
  ...
  if (['/pricing', '/analyze', '/landing'].includes(p))
    return { priority: '0.9', changefreq: 'weekly' };
  if (['/insights', '/blogs', '/changelog', '/press'].includes(p))
    return { priority: '0.8', changefreq: 'weekly' };
  if (/^\/(platforms|problems|signals|industries)$/.test(p))
    return { priority: '0.7', changefreq: 'weekly' };
  if (p.startsWith('/blogs/')) return { priority: '0.8', changefreq: 'monthly' };
  if (['/privacy', '/terms', '/disclosures'].includes(p))
    return { priority: '0.3', changefreq: 'monthly' };
  if (['/compliance', '/server-headers', '/verify-license', '/badge'].includes(p))
    return { priority: '0.6', changefreq: 'monthly' };
  if (['/about-aivis', '/what-is-aivis', '/why-aivis-exists', '/what-is-cite-ledger'].includes(p))
    return { priority: '0.9', changefreq: 'weekly' };
  if (p.startsWith('/methodology/') || p.startsWith('/evidence/'))
    return { priority: '0.8', changefreq: 'weekly' };
...
const routeGroups = [
  {
    ...
    filter: (p) =>
      !p.includes('/') ||
      (['/', ...(p.match(/^\/[^/]+$/) ? [p] : [])].length > 0 &&
        !/^\/(blogs|compare|platforms|problems|signals|industries)/.test(p) &&
        !/^\/tools\//.test(p)),
  },
];
...
console.log(
  `[prerender] generated robots.txt (${publicRoutes.length} Allow, ${ROBOTS_DISALLOW.length} Disallow)`
);
