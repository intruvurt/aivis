export const PLATFORM_NARRATIVE = {
  ...
  wowFactor:
    "The strongest demo is the same site, before and after one structural remediation, with measurable movement in machine readability.",
  sameSiteProof:
  ...
  demoSteps: [
    "Run baseline audit on a live target",
    "Apply one structural fix from evidence",
    "Re-audit the same URL",
    "Show score and category deltas",
  ],
} as const;
