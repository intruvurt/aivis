...
export const problemRawPages: KeywordPage[] = [
...

    {
        ...
        internalLinks: [
            ...
            { label: "Guide: common failures", to: "/guide?section=common-failures" },
        ],
...

    {
        ...
        internalLinks: [
            ...
            { label: "Guide: execute fixes", to: "/guide?section=execute-fixes" },
        ],
...

    {
        ...
        internalLinks: [
            ...
            { label: "Guide: run first audit", to: "/guide?section=run-first-audit" },
        ],
...

    {
        ...
        internalLinks: [
            ...
            { label: "Blocked by robots.txt", to: "/problems/blocked-by-robots-txt" },
            { label: "Guide: baseline setup", to: "/guide?section=baseline-setup" },
        ],
...

    {
        ...
        internalLinks: [
            ...
            { label: "Guide: read results correctly", to: "/guide?section=read-results-correctly" },
        ],
...

    {
        ...
        internalLinks: [
            ...
            { label: "Guide: tool routing", to: "/guide?section=tool-routing" },
        ],
...

    {
        ...
        internalLinks: [
            ...
            { label: "JavaScript rendering blocks AI", to: "/problems/javascript-rendering-blocks-ai" },
            { label: "Guide: start here", to: "/guide?section=start-here" },
        ],
...

    {
        ...
        internalLinks: [
            ...
            { label: "Guide: retest and prove", to: "/guide?section=retest-and-prove" },
        ],
