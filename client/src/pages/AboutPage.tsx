...
const ABOUT_STRUCTURED_DATA = [
  ...
  buildPersonSchema({
    ...
    url: `${BASE_URL}/about`,
    description:
      'AiVIS.biz author profile for AI visibility engineering, machine readability, and citation-readiness strategy.',
    ...
    >
      ...
      <FadeUp delay={0.05}>
        <section className="mx-auto max-w-2xl px-4 py-6 text-center border-b border-white/8 mb-2">
          <p className="text-base text-white/70 leading-relaxed mb-2">
            Built by a solo operator who kept seeing the same problem. Real businesses. Real
            services. Invisible in AI answers.
          </p>
      ...
      <SlideIn from="left" delay={0.05}>
        <section className="border-y border-white/8 bg-white/[0.03] px-4 py-10 sm:px-6 lg:px-8 -mx-4 sm:-mx-6 lg:-mx-8">
          <div className="grid md:grid-cols-[1fr,auto] gap-8 items-start">
            <div>
              <h2 className="text-xl font-bold mb-3 bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">
                Our Mission
              </h2>
              <p className="text-white/65 text-sm leading-relaxed mb-2">
                We help organizations understand how AI and search engines see, extract, and cite
                their digital presence. In an era where AI-generated content drives discovery,
                citation readiness is competitive advantage.
              </p>
              <p className="text-white/55 text-sm leading-relaxed">
                Every audit is a proof point. Every recommendation is actionable. Every citation is
                verifiable.
              </p>
            </div>
            <div className="flex md:flex-col gap-3">
              {[
                ...
                <div
                  key={f.label}
                  className="px-4 py-2.5 rounded-lg border border-white/8 bg-white/[0.04] min-w-[130px]"
                >
            ...
            >
              <div className="p-6">
                ...
                <p className="text-sm text-white/60 leading-relaxed mb-3">
                  Leads vision and engineering. Deep expertise in citation architecture, machine
                  readability and AI extractability.
                </p>
                <p className="text-sm text-white/55 leading-relaxed mb-4">
                  Mission: help businesses survive the shift from searchable websites to AI-readable
                  entities.
                </p>
                ...
                <div className="flex flex-wrap gap-2 text-xs">
                  {[
                    ...
                    <a
                      key={e}
                      href={`mailto:${e}`}
                      className="rounded-full border border-white/8 bg-white/[0.03] px-2.5 py-1 text-white/50 hover:text-white/70 transition"
                    >
                      {e}
                    </a>
                  ))}
                ...
                <div className="mt-4 pt-3 border-t border-white/8 flex flex-wrap gap-1.5">
                  {[
                    ...
                    <span
                      key={t}
                      className="px-2 py-0.5 rounded-full text-[10px] bg-white/[0.04] border border-white/8 text-white/55"
                    >
                      {t}
                    </span>
                  ))}
            ...
            >
              <div className="p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  />
                  <div>
                    <h3 className="text-lg font-bold text-cyan-200">L.L.M.</h3>
                ...
                <p className="text-sm text-white/60 leading-relaxed mb-3">
                  Leads distribution, content marketing, and platform growth strategy. Drives
                  organic reach through SEO, AEO, and community-led visibility campaigns.
                </p>
                <p className="text-sm text-white/55 leading-relaxed mb-4">
                  Handles outreach, content pipeline, and partnership coordination for agencies and
                  builders.
                </p>
                ...
                <div className="mt-4 pt-3 border-t border-white/8 flex flex-wrap gap-1.5">
                  {[
                    ...
                    <span
                      key={t}
                      className="px-2 py-0.5 rounded-full text-[10px] bg-cyan-500/8 border border-cyan-400/10 text-cyan-300/60"
                    >
                      {t}
                    </span>
                  ))}
      ...
      <FadeUp delay={0.05}>
        <section className="px-4 py-10">
          <h2 className="text-2xl font-bold mb-6 text-center bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">
            What the system evaluates
          </h2>
            ...
            {[
              {
                ...
                items: [
                  'Multi-AI citation testing',
                  'Query pack persistence',
                  'Citation parity scoring',
                ],
              },
              {
                icon: Eye,
      ...
      <SlideIn from="left" delay={0.05}>
        <section className="px-4 py-10 bg-white/[0.03] border-y border-white/8 -mx-4 sm:-mx-6 lg:-mx-8 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold mb-2 text-center bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">
            Security & Compliance
          </h2>
          <p className="text-xs text-white/40 text-center mb-6">
            Live controls only. No unverified attestation claims.
          </p>
            ...
            {[
              {
                icon: Shield,
                title: 'SOC 2',
                desc: 'No claim without a formal report available for review.',
              },
              {
                icon: CheckCircle2,
                title: 'VANTA Monitoring',
                desc: 'Shown only when configured and wired to live backend.',
              },
              {
                icon: GitBranch,
                title: 'DRATA Evidence',
                desc: 'Active only when evidence collection is actually configured.',
              },
            ].map((c, i) => (
              <motion.div
                key={c.title}
      ...
      <FadeUp delay={0.05}>
        <section className="px-4 py-8">
          ...
          <p className="text-sm text-white/60 leading-relaxed max-w-3xl">
            In 2026, AiVIS.biz was nominated for TechCrunch Startup Battlefield Top 200 &mdash; an
            early signal that the problem of AI visibility and the way we are solving it are
      ...
      <FadeUp delay={0.05}>
        <section className="px-4 py-8 border-t border-white/8">
          <h2 className="text-xl font-bold mb-4 text-center bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">
            Resources & Support
          </h2>
            ...
            {[
              ...
              >
                ...
                >
                  ...
                  <p className="text-sm font-medium text-white/75 group-hover:text-white transition">
                    {link.label}
                  </p>
      ...
      <SlideIn from="right" delay={0.05}>
        <section className="mx-auto max-w-2xl px-4 py-8 text-center">
          ...
          <p className="text-sm text-white/50 mb-2">
            Not because the business is weak. Because structure, schema, and clarity are misaligned.
          </p>
          <p className="text-sm text-white/45">
        ...
        <section className="px-4 py-10 bg-gradient-to-b from-white/[0.03] to-transparent border-t border-white/8 -mx-4 sm:-mx-6 lg:-mx-8 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-base text-white/55 mb-6">
              AiVIS.biz shows why &mdash; and gives you a way to fix it.
            </p>
            <a
              href="/analyze"
