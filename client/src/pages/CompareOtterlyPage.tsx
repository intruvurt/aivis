...
const OTTERLY_FAQ = [
  {
    question: 'Is Otterly enough for citation recovery?',
    answer:
      'Otterly helps with mention monitoring, but citation recovery typically requires structural diagnostics and implementation-level fixes that AiVIS emphasizes.',
  },
  {
    question: 'What does AiVIS add beyond mention tracking?',
    answer:
      'AiVIS adds deterministic scoring, evidence-linked recommendations, and corrective action paths for extraction and trust blockers.',
  },
];
...
export default function CompareOtterlyPage() {
  usePageMeta({
    ...
    description:
      'AiVIS.biz vs Otterly AI: compare LLM response parsing, entity-trust metrics, and un-gated AEO recommendations side by side.',
    ...
    structuredData: [
      ...
      ...buildFaqSchema(OTTERLY_FAQ, { path: '/compare/aivis-vs-otterly' }),
      buildBreadcrumbSchema([
        { name: 'Home', path: '/' },
        { name: 'Comparison', path: '/compare' },
        { name: 'AiVIS.biz vs Otterly', path: '/compare/aivis-vs-otterly' },
      ]),
    ],
  });
    ...
    <div className="max-w-4xl mx-auto py-12 px-6">
      ...
      <section className="mb-8 rounded-xl border border-indigo-200/60 dark:border-white/10 bg-indigo-50 dark:bg-white/[0.03] p-5">
        ...
        <p className="text-sm text-gray-700 dark:text-white/70 leading-relaxed">
          Otterly monitors mention visibility. AiVIS is built for answer-first citation recovery,
          showing why your page is skipped and which structural changes increase inclusion
          probability across AI answer systems.
        </p>
      </section>
            ...
            <tbody>
              <tr>
                <td className="p-4 border-b border-r dark:border-gray-700 font-medium">
                  Extractability Auditing
                </td>
                <td className="p-4 border-b border-r dark:border-gray-700 bg-green-50/50 dark:bg-green-900/10">
                  <CheckCircle2 className="inline text-green-500 mr-2" /> Full DOM & JSON-LD parsing
                </td>
                <td className="p-4 border-b dark:border-gray-700">
                  <CheckCircle2 className="inline text-gray-400 mr-2" /> Basic URL mention tracking
                </td>
              </tr>
              <tr>
                <td className="p-4 border-b border-r dark:border-gray-700 font-medium">
                  Model Triple-Check Algorithm
                </td>
                <td className="p-4 border-b border-r dark:border-gray-700 bg-green-50/50 dark:bg-green-900/10">
                  <CheckCircle2 className="inline text-green-500 mr-2" /> Yes (Anti-Hallucination)
                </td>
                <td className="p-4 border-b dark:border-gray-700">
                  <XCircle className="inline text-red-400 mr-2" /> Single-pass LLM scoring
                </td>
              </tr>
              <tr>
                <td className="p-4 border-b border-r dark:border-gray-700 font-medium">
                ...
                <td className="p-4 border-b border-r dark:border-gray-700 bg-green-50/50 dark:bg-green-900/10">
                  <CheckCircle2 className="inline text-green-500 mr-2" /> Generates Schema & Header
                  fixes
                </td>
                <td className="p-4 border-b dark:border-gray-700">
                  <XCircle className="inline text-red-400 mr-2" /> Dashboard metrics only
                </td>
              </tr>
              <tr>
                <td className="p-4 border-b border-r dark:border-gray-700 font-medium">
                ...
                <td className="p-4 border-b border-r dark:border-gray-700 bg-green-50/50 dark:bg-green-900/10">
                  <CheckCircle2 className="inline text-green-500 mr-2" /> Structured 8-12
                  recommendations per audit
                </td>
                <td className="p-4 border-b dark:border-gray-700">
                  <XCircle className="inline text-red-400 mr-2" /> Often broad guidance without
