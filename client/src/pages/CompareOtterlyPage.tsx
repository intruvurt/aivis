...
export default function CompareOtterlyPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-6">
        ...
        <img src="/images/ad4.png" alt="AiVIS vs Otterly feature comparison promo" className="max-w-full h-auto max-h-[280px] object-contain rounded-xl opacity-85 hover:opacity-100 transition-opacity" />
      </div>
