  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-6">
      ...
      <p className="text-xl text-gray-700 dark:text-gray-300 mb-8 leading-relaxed">
        Profound is an enterprise solution often focused on heavy, consultative brand analysis. <strong>AiVIS.biz</strong> is a ruthless, lightweight structural auditing engine designed for developers and technical marketers who want immediate code fixes, not month-long consulting cycles.
      </p>
      ...
      <section className="bg-blue-50 dark:bg-blue-900/20 p-8 rounded-2xl border border-blue-100 dark:border-blue-800">
        ...
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          AiVIS.biz is built to be embedded directly into agency tools and technical workflows via API, or used seamlessly via the dashboard to audit a page in under 60 seconds.
        </p>
