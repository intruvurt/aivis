        ...
        <div className="card-charcoal rounded-2xl p-8 border border-white/10">
          ...
          <section className="mb-10">
            ...
            <p className="text-white/70 mb-4 leading-relaxed">
              RankScale is an AI-enhanced SEO platform that generates content recommendations to improve search engine rankings. It analyzes top-ranking pages for a target keyword, then uses AI models to recommend content structure, topic coverage, and semantic relevance improvements. The goal is higher positions in traditional search results.
            </p>
            <p className="text-white/70 leading-relaxed">
              This approach applies AI as a content optimization layer for search engines. RankScale helps you write content that search engines rank higher. It does not audit whether that content is structurally extractable by AI answer engines that generate answers from source material.
            </p>
          </section>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse bg-white/[0.03] rounded-lg overflow-hidden">
                ...
                <tbody className="text-sm">
                  {[
                    ["Primary purpose", "AI citation readiness & visibility auditing", "AI-enhanced content optimization for search rankings", true, true],
                    ["AI content generation", "Not a focus (audits existing content)", "AI-generated content recommendations", false, true],
                    ...
                    ["Answer block density", "Evaluates quotable answer block structure", "Content structure recommendations (for SEO)", true, false],
                    ["AI citation testing", "Live verification across 3 search engines in parallel", "Not available", true, false],
                    ["Multi-model validation", "Triple-Check: 3 AI models, peer critique, validation gate", "Single-model content recommendations", true, false],
                    ["Keyword optimization", "Not a focus", "Keyword targeting and semantic relevance scoring", false, true],
                    ...
                    ["Free tier", "Observer: 10 audits/mo, full fidelity", "Free trial, paid plans for ongoing use", true, false],
                    ...
                    <tr key={i} className="border-b border-white/5 last:border-b-0">
                      ...
                      <td className="p-3 text-white/60">
                        {rankscaleYes ? <CheckCircle2 className="inline text-purple-400 mr-1.5 h-4 w-4" /> : <XCircle className="inline text-white/20 mr-1.5 h-4 w-4" />}
                        {rankscale as string}
                      </td>
                    </tr>
                  ))}
