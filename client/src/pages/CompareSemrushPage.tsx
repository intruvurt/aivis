        ...
        <div className="card-charcoal rounded-2xl p-8 border border-white/10">
          ...
          <p className="text-lg text-white/75 mb-8 leading-relaxed">
            ...
            <strong className="text-white">
              AiVIS.biz measures whether AI answer engines can read, trust, and cite your website.
            </strong>{' '}
            These are different problems requiring different measurement layers. This page explains
            exactly where each tool excels and where the gap between them matters.
          </p>
          ...
          <section className="mb-10">
            ...
            <p className="text-white/70 mb-4 leading-relaxed">
              Semrush is a comprehensive digital marketing platform. It tracks keyword rankings
              across 140+ country databases, maps backlink profiles, runs site audits for crawl
              errors and broken links, monitors paid ad positions, and estimates organic traffic.
              For traditional search engine optimization, Semrush provides deep competitive
              intelligence.
            </p>
            <p className="text-white/70 leading-relaxed">
              Semrush added AI-related features including AI Overview tracking and AI-powered
              content suggestions. These tell you where AI overviews appear in Google search
              results. They do not tell you whether your content is structurally ready to be cited
              by ChatGPT, Perplexity, Claude, or Gemini.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-white/70 mb-4 leading-relaxed">
              AiVIS.biz is not an SEO tool. CITE LEDGER is a structured attribution system developed
              by AiVIS that tracks how AI models interpret, reference, and cite web content across
              answer engines like ChatGPT, Perplexity, Google AI Overviews, and Claude. It audits
              five structural dimensions: crawlability, extractability, trust signals, scoring
              consistency via multi-model validation, and operational follow-through with automated
              code fixes.
            </p>
            <p className="text-white/70 leading-relaxed">
              Where Semrush tells you how you rank in Google, AiVIS.biz tells you whether AI systems
              can understand your content well enough to include it in generated answers. The output
              is a visibility score with evidence-linked recommendations and, on the Score Fix tier,
              automated GitHub pull requests that implement the fixes.
            </p>
          </section>
                ...
                <tbody className="text-sm">
                  {[
                    [
                      ...
                      'Keyword rankings & SEO intelligence',
                      true,
                      true,
                    ],
                    [
                    ...
                    [
                      'Backlink analysis',
                      'Not a focus',
                      'Deep backlink index & competitive gaps',
                      false,
                      true,
                    ],
                    [
                    ...
                    [
                      ...
                      'Brand/author/organization entity coherence scoring',
                      'Not measured',
                      true,
                      false,
                    ],
                    ...
                    [
                      ...
                      'Single-pass AI content suggestions',
                      true,
                      false,
                    ],
                    [
                      'AI Overview tracking',
                      'Not a focus (measures the input, not SERP features)',
                      'Tracks AI Overview presence in Google SERPs',
                      false,
                      true,
                    ],
                    [
                    ...
                    [
                      ...
                      'Brand Monitoring add-on (paid)',
                      true,
                      true,
                    ],
                    [
                      'MCP protocol',
                      'AI agents can invoke tools programmatically',
                      'Not available',
                      true,
                      false,
                    ],
                    ...
                    [
                      ...
                      'Author E-E-A-T, policy pages, claim consistency',
                    ...
                    [
                      ...
                      'Limited free tools, most features require paid plan',
                      true,
                      false,
                    ],
                    ...
                    <tr key={i} className="border-b border-white/5 last:border-b-0">
                      ...
                      <td className="p-3 text-white/60">
                        {semrushYes ? (
                          <CheckCircle2 className="inline text-blue-400 mr-1.5 h-4 w-4" />
                        ) : (
          ...
          <section className="mb-10">
            ...
            <p className="text-sm text-white/55 mt-4">
              The practical recommendation: keep Semrush for search rankings. Add AiVIS.biz for AI
              citation readiness. Both layers matter. One without the other leaves you blind to half
          ...
          <section className="mb-10">
            ...
            <p className="text-white/70 mb-4 leading-relaxed">
              Semrush was built for a world where users click blue links. AI answer engines bypass
              that model entirely - they synthesize answers from extracted content. The signals they
              evaluate to select sources are fundamentally different from Google ranking factors.
            </p>
            <p className="text-white/70 leading-relaxed">
              Content extractability, answer block density, entity graph coherence, and
              cross-platform citation presence have no equivalent in traditional SEO metrics. This
              is not a criticism of Semrush. It was not designed to measure what AI systems evaluate
              because AI answer engines did not exist when it was built. AiVIS.biz was built
              specifically for this measurement layer.
            </p>
          </section>
          ...
          <p className="text-xs text-white/40 mt-6">
            Semrush is a trademark of Semrush Inc. This comparison reflects publicly available
            feature information as of March 2026. AiVIS.biz is not affiliated with Semrush.
          </p>
        </div>
      </section>
    </div>
