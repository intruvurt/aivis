    ...
    <div className="min-h-screen page-splash-bg bg-[#121725] text-white">
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-10 grid gap-6 md:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] items-start">
          <div className="rounded-2xl border border-white/10 bg-charcoal p-6">
            ...
            <p className="text-white/75 leading-relaxed">
              ...
              this URL be safely cited as evidence in AI-generated answers?</span>
            </p>
          </div>
          ...
          <aside className="rounded-2xl border border-cyan-500/40 bg-cyan-500/10 p-6">
            ...
            <ul className="text-sm text-white/80 space-y-2 list-disc list-inside">
              <li>Own or influence content that should be cited by ChatGPT, Perplexity, Gemini, or Claude.</li>
        ...
        <section className="mb-10 space-y-6 rounded-2xl border border-white/10 bg-charcoal p-6">
          ...
          <p className="text-white/75 leading-relaxed">
            That narrowness shows up in the product:
          </p>
          <ul className="list-disc list-inside space-y-2 text-white/75">
            <li>
              Audits are <span className="font-semibold">page-first</span>, not domain-first. You see fixes tied
              to specific URLs, headings, schema blocks, and entity mentions.
            </li>
            <li>
              Recommendations are written for <span className="font-semibold">answer engines</span>, not just
              blue-link SERPs. They assume the reader is a model trying to cite you.
            </li>
            <li>
              The analytics views roll up <span className="font-semibold">structural change over time</span>, not
              just average scores, so you can see which fixes actually moved citation readiness.
            </li>
          </ul>
          <p className="text-white/75 leading-relaxed">
