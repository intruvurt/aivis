...
export default function FAQ() {
  ...
  usePageMeta({
    title: "AiVIS.biz FAQ | Plans, scoring, data, and platform answers",
    description: "Common questions about AiVIS.biz pricing, methodology, privacy, scoring, and AI visibility workflows.",
    path: "/faq",
    structuredData: [
      buildWebPageSchema({
        path: "/faq",
