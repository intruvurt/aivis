      ...
      <section className="py-20 bg-[#0a0a0f] border-t border-white/8">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <dl className="space-y-5">
            {([
              { q:'What is included in the free tier?', a:'Observer includes 3 audits per month with up to 3 pages per audit. You get verdict, top blockers, and a competitor gap preview. Full evidence + competitor source intelligence are intentionally locked for paid tiers.' },
