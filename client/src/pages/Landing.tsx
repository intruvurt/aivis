...
const steps = [
  {
    title: "Run the crawl",
    description: "We extract the exact page signals answer engines depend on: schema, headings, metadata, structure, and direct-answer quality.",
    icon: Search,
  },
  {
    title: "See the blockers",
    description: "The report shows what is missing, what is weak, and what is preventing your content from being trusted or cited.",
    icon: Shield,
  },
  {
    title: "Ship the fix",
    description: "Turn findings into execution. Re-audit after implementation and prove whether visibility actually moved.",
    icon: FileCheck2,
  },
] as const;
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[minmax(0,1.1fr)_28rem] lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-5 text-4xl font-semibold tracking-tight text-white sm:text-5xl lg:text-6xl">
              Find out whether AI cites your site, trusts it, or skips it.
            </h1>
            <p className="mt-5 max-w-2xl text-lg leading-8 text-white/68">
              One audit shows whether answer engines can extract your claims, understand your structure, and treat your site as a trustworthy source.
            </p>
          ...
          <div className="rounded-[28px] border border-white/10 bg-[#0b1422]/92 p-6 shadow-[0_30px_80px_rgba(0,0,0,0.45)] backdrop-blur">
            ...
            <div className="mt-6 rounded-2xl border border-white/10 bg-white/[0.03] p-4">
              ...
              <ul className="mt-3 space-y-2 text-sm text-white/66">
                ...
                <li>Priority blockers tied to crawl evidence</li>
                <li>Remediation path for engineering and content teams</li>
              </ul>
            </div>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-semibold tracking-tight text-white">Three steps. No giant feature wall.</h2>
          </div>
      ...
      <section className="border-t border-white/8 py-16">
        <div className="mx-auto flex max-w-4xl flex-col items-start gap-5 px-4 sm:px-6 lg:px-8 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-semibold tracking-tight text-white">Run the audit. See the score. Fix the blockers.</h2>
            <p className="mt-3 max-w-2xl text-sm leading-7 text-white/62">
              The landing page should get you to the product fast. Everything else lives deeper in the docs and app.
            </p>
          </div>
          <Link
