...
const scoreBands = [
  {
    ...
    description:
      'Consistently citable, structurally strong, and accurately extractable across major AI answer engines. Content at this level is routinely used as a primary source.',
  },
  {
    badge: 'B — Good',
    range: '60 – 79',
    ...
    description:
      'Generally citation-ready with a small number of structural or trust gaps. Typically fixable with targeted schema, heading, or metadata improvements.',
  },
  {
    badge: 'C — Fair',
    range: '40 – 59',
    ...
    description:
      'Parseable but frequently deprioritized by AI models against structurally stronger competitors. Extraction errors and entity confusion are common.',
  },
  {
    badge: 'D — Poor',
    range: '20 – 39',
    ...
    description:
      'Significant structural barriers reduce AI trust and extraction quality. Most findings at this level are high-confidence, high-impact issues.',
  },
  {
    badge: 'F — Critical',
    range: '0 – 19',
    ...
    description:
      'The page is not practically citable in its current state. AI models either cannot access the content or cannot reliably extract any usable claims.',
  },
] as const;
...
const methodologyFaq = [
  ...
  },
  {
    ...
    answer: `${BRAG_ACRONYM} stands for ${BRAG_EXPANSION}. It is the evidence protocol that ensures every finding and recommendation in an AiVIS.biz audit maps back to a crawl-observable signal. The protocol eliminates speculative recommendations and makes every finding independently verifiable.`,
  },
  {
...
const failureModes = [
  {
    ...
    detail:
      'A robots.txt Disallow for GPTBot, ClaudeBot, or PerplexityBot terminates the extraction pipeline at step one. The page is permanently invisible to that AI engine regardless of content quality. This is the most silent failure — no error is surfaced to the site owner.',
  ...
  },
  {
    ...
    detail:
      'Without Organization or Article schema, AI models cannot determine who published the content, when it was written, or whether it is still accurate. Unnamed sources are deprioritized during answer reconstruction. The model treats the page as an anonymous fragment.',
  ...
  },
  {
    ...
    detail:
      'AI crawlers do not execute JavaScript. React, Vue, and Angular apps without SSR or static generation serve an empty document to the crawler. The model receives no content to extract — the page effectively does not exist in the AI index.',
  ...
  },
  {
    ...
    detail:
      'AI models compress pages into dense latent representations. Pages with fewer than 500–600 words of substantive text produce weak representations that are outcompeted by denser sources covering the same topic. The page is accessed and parsed — then overridden.',
  ...
  },
  {
    ...
    detail:
      "AI extraction segments content into chunks using heading boundaries. A flat structure (all H2, no H3) produces undifferentiated chunks. Duplicate H1s force the model to arbitrarily choose which heading represents the page's primary claim. Both patterns reduce extraction accuracy.",
  ...
  },
  {
    ...
    detail:
      "AI models use meta descriptions as pre-compressed page summaries during initial retrieval scoring. A missing or generic description forces the model to generate its own summary, introducing distortion risk — the generated summary may not match the page's actual claims.",
...
export default function MethodologyPage() {
  usePageMeta({
    ...
    ogDescription: `Complete scoring framework: CITE LEDGER pipeline, ${BRAG_PROTOCOL_LABEL}, six dimension weights, triple-check consensus, and methodology FAQ.`,
    ogType: 'article',
    structuredData: [
      buildWebPageSchema({
        path: '/methodology',
      ...
      buildTechArticleSchema({
        title: 'AiVIS.biz Methodology — CITE LEDGER & BRAG Evidence Protocol',
        description:
          'Technical breakdown of AiVIS.biz scoring dimensions, BRAG evidence protocol, and deterministic citation-readiness evaluation.',
        path: '/methodology',
      ...
      buildHowToSchema({
        name: 'How to use the AiVIS.biz methodology',
        description:
          'Run an evidence-backed methodology loop: baseline audit, prioritize deterministic findings, implement fixes, and re-audit for measurable citation-readiness change.',
        url: 'https://aivis.biz/methodology',
        steps: [
          {
            name: 'Run baseline audit',
            text: 'Capture the initial score, dimension breakdown, and evidence-linked findings for the target URL.',
          },
          {
            name: 'Prioritize deterministic findings',
            text: 'Start with crawl-verifiable blockers affecting schema clarity, heading structure, and extraction fidelity.',
          },
          {
            name: 'Implement corrective actions',
            text: 'Apply fixes mapped to BRAG evidence IDs so every change has a traceable rationale.',
          },
          {
            name: 'Re-audit and compare',
            text: 'Measure score deltas and citation-readiness movement against the stored baseline snapshot.',
          },
        ],
      }),
      buildFaqSchema(
    ...
    >
      ...
      <section className="space-y-6">
        ...
        <div className="rounded-3xl border border-cyan-400/20 bg-cyan-400/[0.04] p-5">
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-cyan-300/70 mb-3">
            What the AiVIS.biz score measures
          </p>
          <p className="text-base leading-7 text-white/88 font-medium">
            The AiVIS.biz score measures whether an AI answer engine can structurally access, parse,
            trust, and cite a page. It is not an SEO score. It does not measure rankings, backlinks,
            or keyword density. It measures extraction fidelity: can an AI model reproduce your
            content accurately when reconstructing an answer?
          </p>
        </div>

        <div className="space-y-4">
          <p className="text-base leading-7 text-white/64">
            AI answer engines do not rank pages — they extract fragments, compress them into
            internal representations, and reconstruct answers. A page that ranks #1 in Google may
            score below 30 in AiVIS.biz if the extraction pipeline fails silently.
          </p>
          <p className="text-base leading-7 text-white/64">
            Every AiVIS.biz finding traces back to a crawl-observable signal: an HTML element,
            JSON-LD block, meta tag, or server header. The audit score is a weighted composite
            across six dimensions, each targeting a distinct failure point in the AI extraction
            pipeline.
          </p>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <article className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
            <div className="flex items-center gap-2 text-sm font-medium text-white">
              <ShieldCheck className="h-4 w-4 text-emerald-300" /> Evidence-grounded
            </div>
            <p className="mt-3 text-sm leading-6 text-white/64">
              Every recommendation is tied back to crawl evidence. If AiVIS.biz cannot observe it on
              the page, it does not claim it as a finding.
            </p>
          </article>
          <article className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
            <div className="flex items-center gap-2 text-sm font-medium text-white">
              <Sparkles className="h-4 w-4 text-orange-300" /> Extraction-first
            </div>
            <p className="mt-3 text-sm leading-6 text-white/64">
              A page can rank #1 in Google and score below 40 in AiVIS.biz. Traditional search
              ranking and AI extraction fidelity are independent problems with independent fixes.
            </p>
          </article>
        </div>
      </section>
      ...
      <section className="mt-12">
        <div className="flex items-center justify-between flex-wrap gap-3 mb-5">
          ...
          <span className="text-xs text-white/35 border border-white/10 rounded-full px-3 py-1">
            Aggregate only · No individual data exposed
          </span>
        </div>
        <p className="mb-5 text-sm leading-6 text-white/56">
          These figures are computed from audits run through AiVIS.biz. They reflect structural
          patterns across the full audited page set and are used to calibrate score band thresholds
          and dimension weightings. Individual results vary significantly.
        </p>
      ...
      <section className="mt-12">
        ...
        <div className="mt-5 rounded-3xl border border-white/10 bg-white/[0.03] p-5">
          ...
          <p className="mt-3 text-sm leading-7 text-white/66">
            Score = Content Depth × 0.20 + Schema Coverage × 0.20 + AI Readability × 0.20 +
            Technical SEO × 0.15 + Metadata Quality × 0.13 + Heading Structure × 0.12
          </p>
      ...
      <section className="mt-12">
        <h2 className="text-2xl font-semibold tracking-tight text-white">
          The 7 most common extraction failures
        </h2>
        <p className="mt-3 text-sm leading-6 text-white/60">
          Ranked by frequency across audited pages. Each failure mode suppresses AI citation
          probability without affecting traditional search rankings — sites experiencing them rarely
          ...
          {failureModes.map((mode) => (
            ...
            >
              <div className="flex items-start gap-4">
                <span className="text-xs font-mono font-bold text-white/22 shrink-0 pt-0.5 tabular-nums">
                  {mode.rank}
                </span>
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
                    <h3 className="text-base font-semibold text-white">{mode.title}</h3>
                    <span className="text-xs font-semibold text-amber-300/80 bg-amber-400/10 border border-amber-400/20 rounded-full px-2 py-0.5 shrink-0">
                      {mode.stat}
                    </span>
                  </div>
                  <p className="mt-2 text-sm leading-6 text-white/60">{mode.detail}</p>
                  <p className="mt-2 text-xs leading-5 text-cyan-300/70">
                    <span className="font-semibold text-cyan-300/90">Fix →</span> {mode.fix}
                  </p>
                </div>
              </div>
            </article>
      ...
      <section className="mt-12">
        ...
        <p className="mt-3 text-base leading-7 text-white/60">
          Each dimension targets a specific failure point in the AI extraction pipeline. Strong
          performance across all six means AI models have everything they need to extract,
          attribute, and reproduce your content accurately.
        </p>
              ...
              <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                <div className="flex-1">
                  ...
                  <p className="mt-2 text-sm leading-6 text-white/64">
                    <span className="text-white/50 font-medium">Signals:</span> {dimension.signals}
                  </p>
                  <p className="mt-2 text-sm leading-6 text-white/54">
                    <span className="text-white/50 font-medium">Why it matters:</span>{' '}
                    {dimension.whyItMatters}
                  </p>
                </div>
                <div className="rounded-full border border-white/10 bg-white/[0.04] px-3 py-1 text-xs font-semibold text-cyan-200 shrink-0">
                  {dimension.weight}
                </div>
              </div>
            </article>
      ...
      <section className="mt-12 grid gap-10 lg:grid-cols-2">
        <div>
          <h2 className="text-2xl font-semibold tracking-tight text-white">
            {BRAG_TRAIL_LABEL} protocol
          </h2>
          <p className="mt-3 text-sm leading-7 text-white/56">
            {BRAG_ACRONYM} ({BRAG_EXPANSION}) is the evidence framework that governs every AiVIS.biz
            audit. It enforces a chain of traceability from raw page observation to final
            recommendation — eliminating the gap between "best practice advice" and "evidence-backed
            diagnosis."
          </p>
            ...
            {bragSteps.map((step) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <span className="flex h-9 w-9 items-center justify-center rounded-2xl bg-orange-400/12 text-sm font-semibold text-orange-200">
                    {step.letter}
                  </span>
        ...
        <div>
          ...
          <p className="mt-3 text-sm leading-7 text-white/56">
            Every audit follows the same six-stage pipeline. The pipeline is deterministic through
            stage 3 (crawl evidence only). Stages 4–5 introduce AI model analysis on paid tiers.
            Stage 6 commits the result as an immutable baseline for future comparison.
          </p>
          <div className="mt-5 space-y-4">
      ...
      <section id="cite-ledger" className="mt-12 scroll-mt-24">
        ...
        <p className="mt-3 text-base leading-7 text-white/64">
          <strong className="text-white/88">CITE LEDGER</strong> is a structured attribution system
          developed by AiVIS that tracks how AI models interpret, reference, and cite web content
          across answer engines like ChatGPT, Perplexity, Google AI Overviews, and Claude. BRAG (
          {BRAG_EXPANSION}) is the evidence protocol. CITE LEDGER is the structured record each
          audit produces — the transformation layer that converts messy scraped content into
          deterministic, citable ground truth. ML is not used as a generator. It operates as a{' '}
          <em>deterministic filter</em>: its job is to reject any scraped evidence that does not
          meet the structural requirements for a valid citation.
        </p>
        ...
        <div className="mt-6">
          ...
          <p className="text-sm leading-6 text-white/56 mb-5">
            The ML model is trained on audit failures (where citations were rejected or incorrect)
            and manual fixes (human corrections to data). Each phase transforms the data closer to
                ...
                <div className="flex flex-col gap-3 md:flex-row md:items-start md:gap-5">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-white/45 mb-2">
                      <span>
                        <span className="font-medium text-white/55">Input:</span> {phase.input}
                      </span>
                      <span>
                        <span className="font-medium text-white/55">Output:</span> {phase.output}
                      </span>
                    </div>
        ...
        <div className="mt-8">
          ...
          <p className="text-sm leading-6 text-white/56 mb-5">
            For data to be citable, it must transition from subjective interpretation to objective
            reference. The pipeline enforces this through three layers.
          </p>
          <div className="grid gap-4 sm:grid-cols-3">
            <article className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
              <p className="text-xs font-semibold uppercase tracking-[0.16em] text-orange-300/70 mb-2">
                Upstream
              </p>
              <h4 className="text-base font-semibold text-white">Evidence capture</h4>
              <p className="mt-2 text-sm leading-6 text-white/64">
                The system captures the DOM snapshot and Computed CSS at the moment of extraction.
                This evidence is non-negotiable and forms the permanent base layer of every CITE
                LEDGER record.
              </p>
            </article>
            <article className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
              <p className="text-xs font-semibold uppercase tracking-[0.16em] text-cyan-300/70 mb-2">
                ML Auditor
              </p>
              <h4 className="text-base font-semibold text-white">Stability classification</h4>
              <p className="mt-2 text-sm leading-6 text-white/64">
                A classifier trained on citable vs. non-citable data evaluates DOM element
                stability. If an element's ID or class varies too much across audit logs, the ML
                flags it as volatile and requests a more stable anchor.
              </p>
            </article>
            <article className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
              <p className="text-xs font-semibold uppercase tracking-[0.16em] text-emerald-300/70 mb-2">
                Downstream
              </p>
              <h4 className="text-base font-semibold text-white">Reliability scoring</h4>
              <p className="mt-2 text-sm leading-6 text-white/64">
                ML generates a reliability score from 0.0 to 1.0. Only data scoring above 0.98 earns
                a citation handle — a unique, auditable reference that resolves back to the original
                rendered source.
              </p>
            </article>
          </div>
        ...
        <div className="mt-6 rounded-3xl border border-cyan-400/20 bg-cyan-400/[0.04] p-5">
          ...
          <p className="text-sm leading-7 text-white/80">
            ML in the CITE LEDGER pipeline is a{' '}
            <strong className="text-white">deterministic filter</strong>, not a generator. Its job
            is to say "no" to any scraped evidence that does not perfectly align with the structure
            required for a valid citation. By the time data reaches the user, it is not just scraped
            information — it is a verified asset backed by the history of the system's audits and
            fixes.
          </p>
        </div>
      </section>
      ...
      <section className="mt-12">
        <h2 className="text-2xl font-semibold tracking-tight text-white">
          How AI answer engines extract a page
        </h2>
        <div className="mt-5 space-y-5">
          <p className="text-base leading-7 text-white/64">
            AI and traditional search indexing are not the same pipeline. AI answer engines compress
            pages into internal representations and reconstruct answers from those representations —
            they do not surface links to keyword-matched pages. Each step below is a failure point
            the AiVIS.biz score is designed to detect.
          </p>
          <div className="grid gap-4 sm:grid-cols-2">
            <article className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
              <h3 className="text-base font-semibold text-white">1. Crawl and access</h3>
              <p className="mt-3 text-sm leading-6 text-white/64">
                The AI crawler (GPTBot, ClaudeBot, PerplexityBot) requests the page. If robots.txt
                blocks the crawler, or if a WAF/CDN rate-limits the request, extraction never
                begins. This is the most common and most silent failure mode.
              </p>
            </article>
            <article className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
              <h3 className="text-base font-semibold text-white">2. HTML parsing and rendering</h3>
              <p className="mt-3 text-sm leading-6 text-white/64">
                The crawler parses the HTML response. Client-side-only rendering (React, Vue,
                Angular without SSR) produces an empty shell. The model receives no content.
                Server-side rendering or static generation is required for extraction.
              </p>
            </article>
            <article className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
              <h3 className="text-base font-semibold text-white">3. Structured data extraction</h3>
              <p className="mt-3 text-sm leading-6 text-white/64">
                JSON-LD blocks are parsed to identify entities (Organization, Person, Article),
                relationships, dates, and claims. This is the primary mechanism for entity
                disambiguation — the model uses schema data to determine who published what and
                when.
              </p>
            </article>
            <article className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-white/64">
                The content is compressed into a latent representation — a dense vector that
                captures the semantic fingerprint of the page. Pages with more specific,
                evidence-dense claims produce stronger representations that compete better against
            ...
            <article className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-white/64">
                When a user asks a question, the model retrieves relevant page representations and
                reconstructs an answer. If the source page had clear, atomic claims with supporting
                context, the reconstruction is faithful. If the source was vague, the model may
                hallucinate or attribute the claim to a competing source.
              </p>
            </article>
            <article className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
              <h3 className="text-base font-semibold text-white">6. Citation attribution</h3>
              <p className="mt-3 text-sm leading-6 text-white/64">
                Citation-capable engines (Perplexity, ChatGPT with browsing, Gemini) link claims
                back to source URLs. Pages with clear entity identity (Organization schema),
                verifiable dates (datePublished), and structured claims attract more attributions
                than unstructured content.
              </p>
            </article>
          </div>
          <p className="text-sm leading-7 text-white/50">
            Every AiVIS.biz scoring dimension maps to a specific failure point in this extraction
            chain. Content depth affects compression quality (step 4). Schema coverage affects
            entity disambiguation (step 3). AI readability affects reconstruction fidelity (step 5).
            Technical SEO affects access (step 1). Metadata affects classification (step 2). Heading
            structure affects extraction segmentation (step 4).
          </p>
        </div>
      </section>
      ...
      <section className="mt-12">
        ...
        <p className="mt-3 text-base leading-7 text-white/60">
          Score bands translate the 0–100 composite into actionable tiers, calibrated from aggregate
          citation and extraction quality patterns across audited pages.
        </p>
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-2">
          <article className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
            ...
            <p className="mt-2 text-sm leading-6 text-white/56">
              AiVIS.biz does not measure or predict position in traditional search engine result
              pages. The score reflects AI extraction readiness, not Google ranking performance.
            </p>
          </article>
          <article className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
            <h3 className="text-base font-semibold text-white/80">Not a backlink tool</h3>
            <p className="mt-2 text-sm leading-6 text-white/56">
              Backlink volume and domain authority are not inputs to the AiVIS.biz score. A page
              with zero backlinks but excellent structured data and clear claims will outscore a
              page with strong backlinks but invisible content.
            </p>
          </article>
          <article className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
            <h3 className="text-base font-semibold text-white/80">Not a citation guarantee</h3>
            <p className="mt-2 text-sm leading-6 text-white/56">
              AiVIS.biz measures structural readiness for citation. Whether a specific AI model
              cites a specific page depends on query relevance, competitive content, and
              model-specific retrieval behavior — factors outside any audit tool's control.
            </p>
          </article>
          <article className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
            <h3 className="text-base font-semibold text-white/80">Not a compliance audit</h3>
            <p className="mt-2 text-sm leading-6 text-white/56">
              AiVIS.biz does not provide legal, regulatory, or compliance advice. Schema validity
              checking is a structural assessment, not a legal review.
            </p>
          </article>
        </div>
      </section>
