...
/* ─── FAQ ─── */
const faqs = [
  { q: "How many pages can I audit per scan?", a: "Depends on your tier: Observer gets 1 page/scan, Alignment gets 5, Signal gets 15, and Score Fix gets 25 pages per scan." },
