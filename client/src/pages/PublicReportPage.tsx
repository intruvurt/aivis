  ...
  const pageMeta = useMemo(() => {
    ...
    if (audit) {
      ...
      const structuredData = {
        ...
        '@type': 'WebPage',
        name: `AI Visibility Audit: ${domain}`,
        description: `Evidence-backed AI visibility audit for ${domain}, scored ${audit.visibility_score}/100.`,
        url: `https://aivis.biz${basePath}`,
        ...
        mainEntity: {
          ...
          author: { '@type': 'Organization', name: 'AiVIS.biz' },
          itemReviewed: { '@type': 'WebSite', url: audit.url, name: domain },
          reviewRating: {
            '@type': 'Rating',
            ratingValue: audit.visibility_score,
            bestRating: 100,
            worstRating: 0,
          },
        },
      ...
      return {
        ...
        ogDescription: `Evidence-backed AI visibility audit for ${domain}, generated by AiVIS.biz.`,
    ...
    return {
      title: 'Shared Report',
      description: 'View a shared historical AI visibility audit report generated by AiVIS.biz.',
      path: basePath,
