...
const ResetPassword = () => {
  ...
  if (validating) {
    return (
      <div id="src_pages_ResetPassword_validating" className="min-h-screen page-splash-bg bg-[#2e3646] flex items-center justify-center">
  ...
  return (
    <div id="src_pages_ResetPassword_main" className="min-h-screen page-splash-bg bg-[#2e3646] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
