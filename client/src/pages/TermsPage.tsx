    ...
    <PublicPageFrame icon={FileText} title="Terms of Service" subtitle="Legal terms governing your use of AiVIS" maxWidthClass="max-w-4xl">
      ...
      <div className="prose prose-invert prose-slate max-w-none space-y-8 text-white/75 leading-relaxed bg-charcoal-deep rounded-2xl p-6 border border-white/10">
          ...
          <section>
            ...
            <p>AiVIS is an AiVIS | CITE LEDGER  that analyzes whether AI systems like ChatGPT, Perplexity AI, Google AI Overviews, and Claude can correctly read, interpret, and cite your website. The Service crawls a submitted URL using a headless browser, extracts structural and content signals, routes the data through one or more large language models, and returns a visibility score with evidence-backed findings and recommendations.</p>
