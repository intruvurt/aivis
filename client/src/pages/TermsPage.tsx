    ...
    <PublicPageFrame icon={FileText} title="Terms of Service" subtitle="Legal terms governing your use of the AiVIS platform by Intruvurt Labs" maxWidthClass="max-w-4xl">
      ...
      <div className="prose prose-invert prose-slate max-w-none space-y-8 text-white/75 leading-relaxed bg-charcoal-deep rounded-2xl p-6 border border-white/10">
          ...
          <section>
            ...
            <p>By creating an account on or otherwise accessing AiVIS ("the Service"), you agree to be bound by these Terms of Service ("Terms"). The Service is operated by <strong className="text-white">Intruvurt Labs</strong>, a company incorporated in the State of Georgia, United States.</p>
            <p className="mt-2">If you do not agree, you must stop using the Service immediately. These Terms form a legally binding contract between you and Intruvurt Labs.</p>
          ...
          <section>
            ...
            <p className="mt-2">AiVIS blocks private, localhost, and reserved IP ranges via server-side validation. However, Intruvurt Labs is not liable for any claim arising from your submission of a URL you were not authorized to analyze.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">Webhook deliveries are made on a best-effort basis. Intruvurt Labs does not guarantee delivery, order, or idempotency of webhook payloads. Webhook endpoints must respond within 10 seconds. Failed deliveries are logged but not automatically retried.</p>
          ...
          <section>
            ...
            <p className="mt-2">Without limiting the foregoing, Intruvurt Labs does not warrant that:</p>
            <ul className="list-disc list-inside space-y-1 ml-2 mt-2">
          ...
          <section>
            ...
            <p>TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, INTRUVURT LABS SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOST PROFITS, LOST DATA, BUSINESS INTERRUPTION, REPUTATIONAL HARM, OR COST OF SUBSTITUTE SERVICES, ARISING OUT OF OR RELATED TO YOUR USE OF OR INABILITY TO USE THE SERVICE.</p>
            <p className="mt-2">THE TOTAL AGGREGATE LIABILITY OF INTRUVURT LABS FOR ALL CLAIMS ARISING UNDER OR RELATED TO THESE TERMS SHALL NOT EXCEED THE GREATER OF (A) THE AMOUNT YOU PAID TO INTRUVURT LABS IN THE TWELVE (12) MONTHS PRECEDING THE EVENT GIVING RISE TO THE CLAIM, OR (B) ONE HUNDRED US DOLLARS ($100).</p>
            <p className="mt-2">These limitations apply regardless of the legal theory (contract, tort, strict liability, or otherwise) and even if Intruvurt Labs has been advised of the possibility of such damages.</p>
          </section>

          {/* ── 13 Indemnification ── */}
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">13. Indemnification</h2>
            <p>You agree to indemnify, defend, and hold harmless Intruvurt Labs and its officers, directors, employees, and agents from any claims, losses, damages, liabilities, and expenses (including reasonable attorneys' fees) arising from:</p>
            <ul className="list-disc list-inside space-y-1 ml-2 mt-2">
          ...
          <section>
            ...
            <p>Intruvurt Labs may suspend or terminate your account at any time for violation of these Terms, suspected abuse, or at its sole discretion. Where feasible, we will provide advance notice, but immediate action may be taken without notice in cases involving security threats, fraud, or illegal activity.</p>
          ...
          <section>
            ...
            <p>Intruvurt Labs may update these Terms as the Service evolves. Material changes will be communicated via email or in-app notification at least 30 days before taking effect. Non-material changes (clarifications, formatting) may be applied without advance notice.</p>
          ...
          <section>
            ...
            <p>If any provision of these Terms is held unenforceable, the remaining provisions remain in full force. The failure of Intruvurt Labs to enforce any right or provision shall not constitute a waiver of that right or provision.</p>
          </section>

          {/* ── 19 Entire Agreement ── */}
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">19. Entire Agreement</h2>
            <p>These Terms, together with the <Link to="/privacy" className={linkCls}>Privacy Policy</Link> and <Link to="/disclosures" className={linkCls}>Consumer Disclosures</Link>, constitute the entire agreement between you and Intruvurt Labs with respect to the Service and supersede all prior agreements and understandings.</p>
          </section>
