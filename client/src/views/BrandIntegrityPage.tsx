...
/* ── FAQ data ────────────────────────────────────────── */
const BRAND_INTEGRITY_FAQ = [
  {
    question: 'What is brand integrity monitoring?',
    answer:
      'Brand integrity monitoring tracks what AI platforms and public sources say about your brand. It detects misrepresentations, alias drift, and inaccurate information across 19 sources including Reddit, Hacker News, Google News, and GitHub.',
  },
  {
    question: 'How does brand mention scanning work?',
    answer:
      'AiVIS scans 19 free public sources for mentions of your brand name and URL. Each mention is categorised by sentiment, source, and accuracy so you can detect and respond to misrepresentations before they spread.',
  },
  {
    question: 'Why does brand consistency matter for AI visibility?',
    answer:
      'AI language models learn from public text. If your brand is cited inconsistently — with variant names, wrong descriptions, or conflicting facts — models build a fragmented or inaccurate entity profile. Consistent, accurate public mentions are prerequisite for reliable AI citations.',
  },
  {
    question: 'Which sources does AiVIS scan for brand mentions?',
    answer:
      'AiVIS monitors Reddit, Hacker News, Mastodon, DuckDuckGo/Bing dorks, Google News, GitHub, Quora, Product Hunt, Stack Overflow, Wikipedia, Dev.to, Medium, YouTube, Lobsters, Bluesky, Twitter/X, Lemmy, GitHub Discussions, and more — all without requiring API keys.',
  },
  {
    question: 'Who needs this feature?',
    answer:
      'Any brand seeking to control how AI systems represent them. This is especially critical for companies in technical markets where product descriptions, feature sets, or pricing are frequently discussed in forums and aggregators that feed AI training and retrieval pipelines.',
  },
];
...
const INTEGRITY_SIGNALS = [
  {
    icon: CheckCircle2,
    label: 'Accurate mention',
    color: 'text-emerald-400',
    detail: 'Brand described correctly with factual claims.',
  },
  {
    icon: AlertTriangle,
    label: 'Misrepresentation risk',
    color: 'text-amber-400',
    detail: 'Brand mentioned with potentially inaccurate context or outdated information.',
  },
  {
    icon: XCircle,
    label: 'Absence',
    color: 'text-red-400',
    detail: 'Brand not found where it should appear based on query relevance.',
  },
  {
    icon: Users,
    label: 'Competitor substitution',
    color: 'text-violet-400',
    detail: 'A competitor appears in the answer space that should reference your brand.',
  },
];
...
const VALUE_CARDS = [
  {
    ...
    detail:
      'Track what AI platforms and public sources actually say about your business - and whether it is factually correct.',
  },
  {
    icon: Eye,
    title: 'Detect misrepresentations early',
    detail:
      'Catch inaccurate claims, outdated information, or incorrect associations before they propagate through AI training data.',
  },
  {
    icon: Search,
    title: 'Scan 19 public sources',
    detail:
      'Brand mentions are tracked across Reddit, Hacker News, Mastodon, DuckDuckGo, Bing, Google News, GitHub, Quora, Product Hunt, Stack Overflow, Wikipedia, Dev.to, Medium, YouTube, Lobsters, Bluesky, Twitter/X, Lemmy, and GitHub Discussions - no API keys needed.',
  },
  {
    icon: TrendingUp,
    title: 'Track integrity over time',
    detail:
      'See how brand accuracy and mention sentiment change as you publish corrections, update schema, and improve content.',
  },
];
...
const WORKFLOW_STEPS = [
  {
    step: 1,
    label: 'Enter your brand URL',
    detail:
      'Paste your business URL - brand name, domain, and entity signals are extracted automatically.',
  },
  {
    step: 2,
    label: 'Multi-source scan',
    detail:
      '19 public sources are queried simultaneously for recent brand mentions and references.',
  },
  {
    step: 3,
    label: 'Integrity analysis',
    detail:
      'Each mention is classified: accurate, potentially inaccurate, absent, or displaced by a competitor.',
  },
  {
    step: 4,
    label: 'Timeline tracking',
    detail:
      'View mention history, detect emerging issues, and verify that corrections are propagating.',
  },
];
...
const TIER_PATH = [
  {
    ...
    detail:
      'Run brand mention scans across 19 public sources. See mention history, source breakdown, and integrity timeline.',
  },
  {
    tier: 'Signal',
    title: 'Deep integrity analytics',
    detail:
      'Cross-reference brand mentions with AI citation data. Detect consistency gaps between what AI says and what public sources confirm.',
  },
  {
    tier: 'Score Fix',
    title: 'Automated integrity remediation',
    detail:
      'Generate schema corrections, entity disambiguation patches, and factual claim updates - pushed as evidence-linked PRs.',
  },
];
...
export default function BrandIntegrityPage() {
  ...
  usePageMeta({
    ...
    structuredData: [
      buildWebPageSchema({
        ...
        description:
          'Monitor what AI platforms and public sources say about your brand. Detect misrepresentations, track accuracy over time across 19 sources including Reddit, Hacker News, Google News, and GitHub.',
      }),
  ...
  const handleScan = useCallback(
    async (e?: React.FormEvent) => {
      ...
      if (normalized) {
        try {
          domain = new URL(normalized.startsWith('http') ? normalized : `https://${normalized}`)
            .hostname;
        } catch {
          domain = normalized;
        }
  ...
  if (!hasAccess) {
    return (
      <div>
        <div className="py-16">
          <h1 className="text-2xl font-semibold text-white mb-4">Brand Integrity Monitor</h1>
          <p className="text-white/60 text-lg mb-8 max-w-2xl">
            Monitor what AI platforms and public sources say about your business. Detect
            misrepresentations, track accuracy, and protect your brand narrative across 19 free
            sources.
          </p>
          <UpgradeWall
    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="flex items-center gap-3 mb-2">
          <h1 className="text-xl font-semibold text-white">Brand Integrity Monitor</h1>
        ...
        <p className="text-white/50 text-sm mb-8 max-w-2xl">
          Monitor what AI and public sources say about your brand. Detect inaccuracies, track
          mention history, and protect your brand narrative.
        </p>
        ...
        <div className="flex flex-wrap gap-2 mb-8">
          {MENTION_SOURCES.map((source) => (
            <span
              key={source.name}
              className="px-2.5 py-1 rounded-full border border-slate-700 bg-slate-900 text-white/60 text-xs font-medium"
            >
              {source.name}
            </span>
          ))}
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              ...
              <div className="rounded-xl border border-slate-700 bg-slate-900 p-4">
                ...
                <p className="text-white text-2xl font-bold">
                  {scanResult.sources_checked?.length ?? 0}
                </p>
              </div>
              <div className="rounded-xl border border-slate-700 bg-slate-900 p-4">
                <p className="text-white/40 text-xs font-medium uppercase tracking-wider mb-1">
                ...
                <p className="text-emerald-300 text-lg font-bold truncate">
                  {scanResult.brand || '-'}
                </p>
              </div>
              <div className="rounded-xl border border-slate-700 bg-slate-900 p-4">
            ...
            {scanResult.mentions && scanResult.mentions.length > 0 ? (
              ...
              <div className="text-center py-12 rounded-xl border border-slate-700 bg-slate-900">
                ...
                <p className="text-white/60 text-sm">
                  No brand mentions found across scanned sources.
                </p>
                <p className="text-white/40 text-xs mt-1">
                  This may indicate your brand has low public discussion presence.
                </p>
              </div>
            )}
          </div>
        ...
        {!scanResult && !loading && (
          <div className="text-center py-16">
            ...
            <h3 className="text-white/70 text-lg font-semibold mb-2">
              Enter a URL to scan brand integrity
            </h3>
            <p className="text-white/40 text-sm max-w-md mx-auto">
              The Brand Integrity Monitor scans 17 public sources for mentions of your brand and
              analyzes accuracy, sentiment, and competitor displacement.
            </p>
          </div>
        )}
