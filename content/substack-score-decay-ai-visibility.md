...
If you want to run a fresh baseline, the full audit is at [aivis.biz/analyze](https://aivis.biz/analyze). Observer tier is free, 3 scans. Scheduled rescans start on Alignment at $49/mo. Reply if you want to talk through what to prioritize based on your score.
