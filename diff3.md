...
index 49bc3a0c84b8b22b75a0650e56c17b5b75a3e2bc..57ce9707bb8c27e71527a5efd3ab290c3b2dbe6c 100644
...
index 28889bff9d32735e5f200824087a3722676a7d22..bca56664227c641ccb33afa2635fe487f5391840 100644
...
-    border-radius: 0;
+    background: linear-gradient(180deg, #64748b, #475569 60%, #334155);
+    border-radius: 8px;
     border: 2px solid #0a0c14;
   }
   ::-webkit-scrollbar-thumb:hover {
-    background: linear-gradient(180deg, #fb923c, #fcd34d 50%, #67e8f9);
+    background: linear-gradient(180deg, #94a3b8, #64748b 60%, #475569);
   }
...
-  a[class*="inline-flex"]:hover,
-  a[class*="px-"][class*="py-"]:hover {
-    scrollbar-color: #a78bfa #0a0c14;
-  }
-
-  button:hover::-webkit-scrollbar-thumb,
-  a.inline-flex:hover::-webkit-scrollbar-thumb,
-  a[class*="inline-flex"]:hover::-webkit-scrollbar-thumb,
-  a[class*="px-"][class*="py-"]:hover::-webkit-scrollbar-thumb {
-    background: #a78bfa;
   }
   ...
   .tier-icon-brand {
     filter: saturate(1.1) contrast(1.06) brightness(1.02) drop-shadow(0 2px 6px rgba(94, 234, 212, 0.16));
   }
 
   /* ── Focus / active / selected state system ─────────────────────────── */
 
   /* Strong, branded focus ring – visible on any background */
   :focus-visible {
