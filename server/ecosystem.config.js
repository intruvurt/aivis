...
module.exports = {
  apps: [
    ...
    {
      name: "aivis-worker-fix",
      cwd: "./server",
      script: "npm",
      args: "run worker:fix:prod",
      exec_mode: "fork",
      instances: 1,
      autorestart: true,
      max_restarts: 10,
      ...
      time: true,
      merge_logs: true,
      out_file: "./logs/worker-fix.out.log",
      error_file: "./logs/worker-fix.err.log",
      watch: false,
      env: {
        NODE_ENV: "development",
      },
    ...
    {
      name: "aivis-worker-citations",
      cwd: "./server",
      script: "npm",
      args: "run worker:citations:prod",
      exec_mode: "fork",
      instances: 1,
      autorestart: true,
      max_restarts: 10,
      ...
      time: true,
      merge_logs: true,
      out_file: "./logs/worker-citations.out.log",
      error_file: "./logs/worker-citations.err.log",
      watch: false,
      env: {
        NODE_ENV: "development",
      },
    ...
    {
      name: "aivis-worker-bix",
      cwd: "./server",
      script: "npm",
      args: "run worker:bix:prod",
      exec_mode: "fork",
      instances: 1,
      autorestart: true,
      max_restarts: 10,
      ...
      time: true,
      merge_logs: true,
      out_file: "./logs/worker-bix.out.log",
      error_file: "./logs/worker-bix.err.log",
      watch: false,
      env: {
        NODE_ENV: "development",
      },
