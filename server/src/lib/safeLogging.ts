...
// Environment variable leakage: redact only explicit key assignments (KEY=..., KEY: ...)
const ENV_VAR_PATTERN = /\b(OPENROUTER_API_KEY|OPEN_ROUTER_API_KEY|GOOGLE_CLIENT_SECRET|JWT_SECRET|STRIPE_SECRET_KEY|STRIPE_WEBHOOK_SECRET|DATABASE_PASSWORD|DB_PASSWORD|ADMIN_KEY|SENTRY_DSN|WEBHOOK_SECRET|API_KEY|PAYPAL_SECRET|PAYPAL_API_KEY|PAYPAL_CLIENT_ID|RESEND_API_KEY|SERP_API_KEY|DEEPSEEK_API_KEY|DATABASE_URL|GEEKFLARE_API_KEY|GEEKFLARE_KEY)\b\s*(=|:)\s*[^\s"'}]+/gi;
