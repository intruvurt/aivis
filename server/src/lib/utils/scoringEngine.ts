...
export function computeScores(
  ...
  // Technical and AI optimization are most critical for Ai Visibility Intelligence Audits
...
export function generateRisks(
  ...
  if (!technicalData?.schema?.present || technicalData?.schema?.types?.length === 0) {
    risks.push({
      ...
      impact: 'AI systems cannot understand your content context, entities, or relationships. Severely limits Ai Visibility Intelligence Audits and rich results eligibility.',
