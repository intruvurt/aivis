...
const AI_BOTS = [
  ...
  { name: 'AdIdxBot', key: 'adidxbot', owner: 'Microsoft (Bing Ads quality crawler)', critical: false },
  { name: 'BingPreview', key: 'bingpreview', owner: 'Microsoft (Bing page snapshots)', critical: false },
  { name: 'MicrosoftPreview', key: 'microsoftpreview', owner: 'Microsoft (product page snapshots)', critical: false },
  { name: 'BingVideoPreview', key: 'bingvideopreview', owner: 'Microsoft (video previews in Bing)', critical: false },
