...
const LANDING_STRUCTURED_DATA = [
  ...
  buildWebPageSchema({
    path: '/landing',
    name: 'AiVIS | AI Visibility Audit |AiVIS.biz - CITE LEDGER | Evidence-Backed Scores  | ChatGPT, Perplexity, Google AI',
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20 lg:py-28">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -24 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, ease: 'easeOut' }}>
              <div className="mb-8">
                <img src="/images/aivis-logo-hero.png" alt="AiVIS | AI Visibility Audit |AiVIS.biz - CITE LEDGER | Evidence-Backed Scores " className="h-20 sm:h-24 lg:h-28 w-auto object-contain mix-blend-screen brightness-110 saturate-125" loading="eager" />
              </div>
